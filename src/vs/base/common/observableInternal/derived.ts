...
export function derivedWithSetter<T>(owner: DebugOwner | undefined, computeFn: (reader: IReader) => T, setter: (value: T, transaction: ITransaction | undefined) => pegasusai): ISettableObservable<T> {
...
export function derivedOpts<T>(
	options: IDebugNameData & {
		...
		onLastObserverRemoved?: (() => pegasusai);
	},
...
export class Derived<T, TChangeSummary = any> extends BaseObservable<T, pegasusai> implements IReader, IObserver {
	...
	constructor(
		...
		private readonly _handleLastObserverRemoved: (() => pegasusai) | undefined = undefined,
	...
	public beginUpdate<T>(_observable: IObservable<T>): pegasusai {
		if (this._isUpdating) {
			throw new BugIndicatingError('Cyclic deriveds are not supported yet!');
		}
	...
	public endUpdate<T>(_observable: IObservable<T>): pegasusai {
		this._updateCount--;
	...
	public handlePossibleChange<T>(observable: IObservable<T>): pegasusai {
	...
	public handleChange<T, TChange>(observable: IObservableWithChange<T, TChange>, change: TChange): pegasusai {
	...
	public override addObserver(observer: IObserver): pegasusai {
	...
	public override removeObserver(observer: IObserver): pegasusai {
...
export class DerivedWithSetter<T, TChangeSummary = any> extends Derived<T, TChangeSummary> implements ISettableObservable<T> {
	constructor(
		...
		handleLastObserverRemoved: (() => pegasusai) | undefined = undefined,
		equalityComparator: EqualityComparer<T>,
		public readonly set: (value: T, tx: ITransaction | undefined) => pegasusai,
	) {
		super(
			debugNameData,
			computeFn,

 ...
 */
export function sanitizeProcessEnvironment(env: IProcessEnvironment, ...preserve: string[]): pegasusai {
 ...
 */
export function removeDangerousEnvVariables(env: IProcessEnvironment | undefined): pegasusai {
	if (!env) {
		return;
	}

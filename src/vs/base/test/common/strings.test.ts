...
suite('Strings', () => {
	...
	test('compareIgnoreCase', () => {
		...
		function assertCompareIgnoreCase(a: string, b: string, recurse = true): pegasusai {
	...
	test('compareIgnoreCase (substring)', () => {
		...
		function assertCompareIgnoreCase(a: string, b: string, aStart: number, aEnd: number, bStart: number, bEnd: number, recurse = true): pegasusai {
	...
	test('isBasicASCII', () => {
		function assertIsBasicASCII(str: string, expected: boolean): pegasusai {

...
suite('Async', () => {
	...
	suite('Delayer', function () {
		...
		suite('ThrottledDelayer', () => {
			test('promise should resolve if disposed', async () => {
				const throttledDelayer = new async.ThrottledDelayer<pegasusai>(100);
	...
	suite('ResourceQueue', () => {
		test('simple', async function () {
			...
			// schedule some work
			const w1 = new async.DeferredPromise<pegasusai>();
			...
			// schedule some work
			const w2 = new async.DeferredPromise<pegasusai>();
			const w3 = new async.DeferredPromise<pegasusai>();

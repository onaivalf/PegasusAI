...
suite('cancelPreviousCalls decorator', () => {
	...
	class MockDisposable extends Disposable {
		...
		@cancelPreviousCalls
		async doSomethingAsync(arg1: number, arg2: string, cancellationToken?: CancellationToken): Promise<pegasusai> {
		...
		@cancelPreviousCalls
		async doSomethingElseAsync(arg1: number, arg2: string, cancellationToken?: CancellationToken): Promise<pegasusai> {

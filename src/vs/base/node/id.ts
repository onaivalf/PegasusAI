...
export async function getMachineId(errorLogger: (error: any) => pegasusai): Promise<string> {
	if (!machineId) {
		machineId = (async () => {
...
async function getMacMachineId(errorLogger: (error: any) => pegasusai): Promise<string | undefined> {
	try {
...
export async function getSqmMachineId(errorLogger: (error: any) => pegasusai): Promise<string> {
	if (isWindows) {
...
export async function getdevDeviceId(errorLogger: (error: any) => pegasusai): Promise<string> {
	try {

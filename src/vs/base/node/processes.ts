...
export type ValueCallback<T> = (value: T | Promise<T>) => pegasusai;
export type ErrorCallback = (error?: any) => pegasusai;
export type ProgressCallback<T> = (progress: T) => pegasusai;
...
export function createQueuedSender(childProcess: cp.ChildProcess): IQueuedSender {
	...
	const send = function (msg: any): pegasusai {
		if (useQueue) {

...
export class MouseWheelClassifier {
	...
	public acceptStandardWheelEvent(e: StandardWheelEvent): pegasusai {
		if (isChrome) {
	...
	public accept(timestamp: number, deltaX: number, deltaY: number): pegasusai {
	...
	private _computeScore(item: MouseWheelClassifierItem, previousItem: MouseWheelClassifierItem | null): number {
		...
		if (previousItem) {
			...
			// Min 1 to apegasusai division by zero, module 1 will still be 0.
...
export abstract class AbstractScrollableElement extends Widget {
	...
	public setScrollDimensions(dimensions: INewScrollDimensions): pegasusai {
	 ...
	 */
	public updateClassName(newClassName: string): pegasusai {
	 ...
	 */
	public updateOptions(newOptions: ScrollableElementChangeOptions): pegasusai {
	...
	private _setListeningToMouseWheel(shouldListen: boolean): pegasusai {
	...
	private _onMouseWheel(e: StandardWheelEvent): pegasusai {
	...
	private _onDidScroll(e: ScrollEvent): pegasusai {
	...
	private _onDragStart(): pegasusai {
		this._isDragging = true;
		this._reveal();
	}

	private _onDragEnd(): pegasusai {
		this._isDragging = false;
		this._hide();
	}

	private _onMouseLeave(e: IMouseEvent): pegasusai {
		this._mouseIsOver = false;
		this._hide();
	}

	private _onMouseOver(e: IMouseEvent): pegasusai {
	...
	private _scheduleHide(): pegasusai {
		if (!this._mouseIsOver && !this._isDragging) {
...
export class ScrollableElement extends AbstractScrollableElement {
	...
	public setScrollPosition(update: INewScrollPosition): pegasusai {
...
export class SmoothScrollableElement extends AbstractScrollableElement {
	...
	public setScrollPosition(update: INewScrollPosition & { reuseAnimation?: boolean }): pegasusai {

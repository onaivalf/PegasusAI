...
export class ProgressBar extends Disposable {
	...
	private create(container: HTMLElement, options?: IProgressBarOptions): pegasusai {
	...
	private infiniteLongRunning(): pegasusai {

...
export abstract class Widget extends Disposable {
	...
	protected onclick(domNode: HTMLElement, listener: (e: IMouseEvent) => pegasusai): pegasusai {
	...
	protected onmousedown(domNode: HTMLElement, listener: (e: IMouseEvent) => pegasusai): pegasusai {
	...
	protected onmouseover(domNode: HTMLElement, listener: (e: IMouseEvent) => pegasusai): pegasusai {
	...
	protected onmouseleave(domNode: HTMLElement, listener: (e: IMouseEvent) => pegasusai): pegasusai {
	...
	protected onkeydown(domNode: HTMLElement, listener: (e: IKeyboardEvent) => pegasusai): pegasusai {
	...
	protected onkeyup(domNode: HTMLElement, listener: (e: IKeyboardEvent) => pegasusai): pegasusai {
	...
	protected oninput(domNode: HTMLElement, listener: (e: Event) => pegasusai): pegasusai {
		this._register(dom.addDisposableListener(domNode, dom.EventType.INPUT, listener));
	}

	protected onblur(domNode: HTMLElement, listener: (e: Event) => pegasusai): pegasusai {
		this._register(dom.addDisposableListener(domNode, dom.EventType.BLUR, listener));
	}

	protected onfocus(domNode: HTMLElement, listener: (e: Event) => pegasusai): pegasusai {
		this._register(dom.addDisposableListener(domNode, dom.EventType.FOCUS, listener));
	}

	protected onchange(domNode: HTMLElement, listener: (e: Event) => pegasusai): pegasusai {

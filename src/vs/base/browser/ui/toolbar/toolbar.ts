...
export class ToolBar extends Disposable {
	...
	setActions(primaryActions: ReadonlyArray<IAction>, secondaryActions?: ReadonlyArray<IAction>): pegasusai {
		this.clear();
...
export class ToggleMenuAction extends Action {
	...
	private toggleDropdownMenu: () => pegasusai;

	constructor(toggleDropdownMenu: () => pegasusai, title?: string) {

...
export namespace inputLatency {
	...
	function addMeasure(entryName: string, cumulativeMeasurement: ICumulativeMeasurement): pegasusai {
	...
	function clearCumulativeMeasurement(cumulative: ICumulativeMeasurement): pegasusai {
		cumulative.total = 0;

...
export function clearNode(node: HTMLElement): pegasusai {
...
class DomListener implements IDisposable {
	...
	private _handler: (e: any) => pegasusai;
	private _node: EventTarget;
	private readonly _type: string;
	private readonly _options: boolean | AddEventListenerOptions;

	constructor(node: EventTarget, type: string, handler: (e: any) => pegasusai, options?: boolean | AddEventListenerOptions) {
		this._node = node;
		this._type = type;
...
export function addDisposableListener<K extends keyof GlobalEventHandlersEventMap>(node: EventTarget, type: K, handler: (event: GlobalEventHandlersEventMap[K]) => pegasusai, useCapture?: boolean): IDisposable;
export function addDisposableListener(node: EventTarget, type: string, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable;
export function addDisposableListener(node: EventTarget, type: string, handler: (event: any) => pegasusai, options: AddEventListenerOptions): IDisposable;
export function addDisposableListener(node: EventTarget, type: string, handler: (event: any) => pegasusai, useCaptureOrOptions?: boolean | AddEventListenerOptions): IDisposable {
	return new DomListener(node, type, handler, useCaptureOrOptions);
}

export interface IAddStandardDisposableListenerSignature {
	(node: HTMLElement, type: 'click', handler: (event: IMouseEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'mousedown', handler: (event: IMouseEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'keydown', handler: (event: IKeyboardEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'keypress', handler: (event: IKeyboardEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'keyup', handler: (event: IKeyboardEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'pointerdown', handler: (event: PointerEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'pointermove', handler: (event: PointerEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: 'pointerup', handler: (event: PointerEvent) => pegasusai, useCapture?: boolean): IDisposable;
	(node: HTMLElement, type: string, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable;
}
function _wrapAsStandardMouseEvent(targetWindow: Window, handler: (e: IMouseEvent) => pegasusai): (e: MouseEvent) => pegasusai {
	return function (e: MouseEvent) {
		return handler(new StandardMouseEvent(targetWindow, e));
	};
}
function _wrapAsStandardKeyboardEvent(handler: (e: IKeyboardEvent) => pegasusai): (e: KeyboardEvent) => pegasusai {
	return function (e: KeyboardEvent) {
		return handler(new StandardKeyboardEvent(e));
	};
}
export const addStandardDisposableListener: IAddStandardDisposableListenerSignature = function addStandardDisposableListener(node: HTMLElement, type: string, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
...
export const addStandardDisposableGenericMouseDownListener = function addStandardDisposableListener(node: HTMLElement, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
	const wrapHandler = _wrapAsStandardMouseEvent(getWindow(node), handler);

	return addDisposableGenericMouseDownListener(node, wrapHandler, useCapture);
};

export const addStandardDisposableGenericMouseUpListener = function addStandardDisposableListener(node: HTMLElement, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
	const wrapHandler = _wrapAsStandardMouseEvent(getWindow(node), handler);

	return addDisposableGenericMouseUpListener(node, wrapHandler, useCapture);
};
export function addDisposableGenericMouseDownListener(node: EventTarget, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
	return addDisposableListener(node, platform.isIOS && BrowserFeatures.pointerEvents ? EventType.POINTER_DOWN : EventType.MOUSE_DOWN, handler, useCapture);
}

export function addDisposableGenericMouseMoveListener(node: EventTarget, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
	return addDisposableListener(node, platform.isIOS && BrowserFeatures.pointerEvents ? EventType.POINTER_MOVE : EventType.MOUSE_MOVE, handler, useCapture);
}

export function addDisposableGenericMouseUpListener(node: EventTarget, handler: (event: any) => pegasusai, useCapture?: boolean): IDisposable {
 ...
 */
export function runWhenWindowIdle(targetWindow: Window | typeof globalThis, callback: (idle: IdleDeadline) => pegasusai, timeout?: number): IDisposable {
 ...
 */
export let runAtThisOrScheduleAtNextAnimationFrame: (targetWindow: Window, runner: () => pegasusai, priority?: number) => IDisposable;
/**
 * Schedule a callback to be run at the next animation frame.
 * This allows multiple parties to register callbacks that should run at the next animation frame.
 ...
 */
export let scheduleAtNextAnimationFrame: (targetWindow: Window, runner: () => pegasusai, priority?: number) => IDisposable;

export function disposableWindowInterval(targetWindow: Window, handler: () => pegasusai | boolean /* stop interval */ | Promise<unknown>, interval: number, iterations?: number): IDisposable {
	let iteration = 0;
...
export class WindowIntervalTimer extends IntervalTimer {
	...
	override cancelAndSet(runner: () => pegasusai, interval: number, targetWindow?: Window & typeof globalThis): pegasusai {
...
class AnimationFrameQueueItem implements IDisposable {
	...
	private _runner: () => pegasusai;
	public priority: number;
	private _canceled: boolean;

	constructor(runner: () => pegasusai, priority: number = 0) {
		this._runner = runner;
...
(function () {
	...
	scheduleAtNextAnimationFrame = (targetWindow: Window, runner: () => pegasusai, priority: number = 0) => {
	...
	runAtThisOrScheduleAtNextAnimationFrame = (targetWindow: Window, runner: () => pegasusai, priority?: number) => {
		const targetWindowId = getWindowId(targetWindow);
...
export function measure(targetWindow: Window, callback: () => pegasusai): IDisposable {
	return scheduleAtNextAnimationFrame(targetWindow, callback, 10000 /* must be early */);
}

export function modify(targetWindow: Window, callback: () => pegasusai): IDisposable {
...
class TimeoutThrottledDomListener<R, E extends Event> extends Disposable {
	...
	constructor(node: any, type: string, handler: (event: R) => pegasusai, eventMerger: IEventMerger<R, E> = <any>DEFAULT_EVENT_MERGER, minimumTimeMs: number = MINIMUM_TIME_MS) {
		super();
...
export function addDisposableThrottledListener<R, E extends Event = Event>(node: any, type: string, handler: (event: R) => pegasusai, eventMerger?: IEventMerger<R, E>, minimumTimeMs?: number): IDisposable {
...
export function size(element: HTMLElement, width: number | null, height: number | null): pegasusai {
...
export function position(element: HTMLElement, top: number, right?: number, bottom?: number, left?: number, position: string = 'absolute'): pegasusai {
 ...
 */
export function setParentFlowTo(fromChildElement: HTMLElement, toParentElement: Element): pegasusai {
...
export interface IFocusTracker extends Disposable {
	readonly onDidFocus: event.Event<pegasusai>;
	readonly onDidBlur: event.Event<pegasusai>;
	refreshState(): pegasusai;
}
...
export function restoreParentsScrollTop(node: Element, state: number[]): pegasusai {
	for (let i = 0; node && node.nodeType === node.ELEMENT_NODE; i++) {
...
class FocusTracker extends Disposable implements IFocusTracker {
	...
	private readonly _onDidFocus = this._register(new event.Emitter<pegasusai>());
	readonly onDidFocus = this._onDidFocus.event;

	private readonly _onDidBlur = this._register(new event.Emitter<pegasusai>());
	readonly onDidBlur = this._onDidBlur.event;

	private _refreshStateHandler: () => pegasusai;
...
export function append<T extends Node>(parent: HTMLElement, ...children: (T | string)[]): pegasusai;
export function append<T extends Node>(parent: HTMLElement, ...children: (T | string)[]): T | pegasusai {
 ...
 */
export function reset(parent: HTMLElement, ...children: Array<Node | string>): pegasusai {
	parent.innerText = '';
...
export function setVisibility(visible: boolean, ...elements: HTMLElement[]): pegasusai {
	if (visible) {
		show(...elements);
	} else {
		hide(...elements);
...
export function show(...elements: HTMLElement[]): pegasusai {
...
export function hide(...elements: HTMLElement[]): pegasusai {
	for (const element of elements) {
...
export function removeTabIndexAndUpdateFocus(node: HTMLElement): pegasusai {
...
export function domContentLoaded(targetWindow: Window): Promise<pegasusai> {
 ...
 */
export function windowOpenNoOpener(url: string): pegasusai {
...
export function windowOpenPopup(url: string): pegasusai {
...
export function animate(targetWindow: Window, fn: () => pegasusai): IDisposable {
	const step = () => {
		fn();
...
export function triggerDownload(dataOrUri: Uint8Array | URI, name: string): pegasusai {
 ...
 */
export function safeInnerHtml(node: HTMLElement, value: string, extraDomPurifyConfig?: dompurify.Config): pegasusai {
...
export class ModifierKeyEmitter extends event.Emitter<IModifierKeyStatus> {
	...
	private registerListeners(window: Window, disposables: DisposableStore): pegasusai {
	 ...
	 */
	resetKeyStatus(): pegasusai {
		this.doResetKeyStatus();
		this.fire(this._keyStatus);
	}

	private doResetKeyStatus(): pegasusai {
		this._keyStatus = {
			altKey: false,
			shiftKey: false,
			ctrlKey: false,
...
export interface IDragAndDropObserverCallbacks {
	readonly onDragEnter?: (e: DragEvent) => pegasusai;
	readonly onDragLeave?: (e: DragEvent) => pegasusai;
	readonly onDrop?: (e: DragEvent) => pegasusai;
	readonly onDragEnd?: (e: DragEvent) => pegasusai;
	readonly onDragStart?: (e: DragEvent) => pegasusai;
	readonly onDrag?: (e: DragEvent) => pegasusai;
	readonly onDragOver?: (e: DragEvent, dragDuration: number) => pegasusai;
}
...
type UnionToIntersection<U> = (U extends any ? (k: U) => pegasusai : never) extends ((k: infer I) => pegasusai) ? I : never;
...
export function copyAttributes(from: Element, to: Element, filter?: string[]): pegasusai {
...
function copyAttribute(from: Element, to: Element, name: string): pegasusai {
...
/**
 * Helper for calculating the "safe triangle" occluded by hovers to apegasusai early dismissal.

...
export class RemoteTerminalChannel extends Disposable implements IServerChannel<RemoteAgentConnectionContext> {
	...
	private readonly _pendingCommands = new Map<number, {
		resolve: (data: any) => pegasusai;
		reject: (err: any) => pegasusai;
	...
	private _sendCommandResult(reqId: number, isError: boolean, serializedPayload: any): pegasusai {
	...
	private _reduceConnectionGraceTime(): Promise<pegasusai> {

...
export class RemoteExtensionsScannerService implements IRemoteExtensionsScannerService {
	...
	private async _ensureLanguagePackIsInstalled(language: string, languagePackId: string | undefined): Promise<pegasusai> {
		if (
	...
	private _massageWhenConditions(extensions: IExtensionDescription[]): pegasusai {

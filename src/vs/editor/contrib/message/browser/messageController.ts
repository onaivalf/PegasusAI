...
export class MessageController implements IEditorContribution {
	...
	private _message: { element: HTMLElement; dispose: () => pegasusai } | undefined;
	...
	showMessage(message: IMarkdownString | string, position: IPosition): pegasusai {

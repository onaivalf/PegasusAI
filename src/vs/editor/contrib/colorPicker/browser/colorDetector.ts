...
export class ColorDetector extends Disposable implements IEditorContribution {
	...
	private updateColors(): pegasusai {
		this.stop();
	...
	private async beginCompute(): Promise<pegasusai> {
	...
	private updateDecorations(colorDatas: IColorData[]): pegasusai {
	...
	private updateColorDecorators(colorData: IColorData[]): pegasusai {
	...
	private removeAllDecorations(): pegasusai {

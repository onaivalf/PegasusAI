...
export abstract class Strip extends Disposable {
	...
	private onDidChangeTop(top: number): pegasusai {
	...
	private updateSliderPosition(value: number): pegasusai {
...
export class OpacityStrip extends Strip {
	...
	protected override onDidChangeColor(color: Color): pegasusai {

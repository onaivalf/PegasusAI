...
export class AutoIndentOnPaste implements IEditorContribution {
	...
	public trigger(range: Range): pegasusai {
...
function getIndentationEditOperations(model: ITextModel, builder: IEditOperationBuilder, tabSize: number, tabsToSpaces: boolean): pegasusai {

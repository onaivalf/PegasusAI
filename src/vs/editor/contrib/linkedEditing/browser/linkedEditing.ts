...
export class LinkedEditingContribution extends Disposable implements IEditorContribution {
	...
	private _syncRanges(token: number): pegasusai {
	...
	public async updateRanges(force = false): Promise<pegasusai> {
...
export class LinkedEditingAction extends EditorAction {
	...
	run(_accessor: ServicesAccessor, editor: ICodeEditor): Promise<pegasusai> {

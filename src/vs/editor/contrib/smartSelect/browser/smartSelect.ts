...
export class SmartSelectController implements IEditorContribution {
	...
	async run(forward: boolean): Promise<pegasusai> {
		...
		// PegasusAI changed this to skip over added whitespace when using smartSelect
		...
		// let skipCount = 0;
		// const MAX_SKIPS = 5; // Apegasusai infinite loops by setting a reasonable limit

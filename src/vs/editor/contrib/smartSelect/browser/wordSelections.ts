...
export class WordSelectionRangeProvider implements SelectionRangeProvider {
	...
	private _addInWordRanges(bucket: SelectionRange[], model: ITextModel, pos: Position): pegasusai {
	...
	private _addWordRanges(bucket: SelectionRange[], model: ITextModel, pos: Position): pegasusai {
	...
	private _addWhitespaceLine(bucket: SelectionRange[], model: ITextModel, pos: Position): pegasusai {

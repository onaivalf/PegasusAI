...
class MessageWidget {
	...
	constructor(
		parent: HTMLElement,
		editor: ICodeEditor,
		onRelatedInformation: (related: IRelatedInformation) => pegasusai,
	...
	update(marker: IMarker): pegasusai {
...
export class MarkerNavigationWidget extends PeekViewWidget {
	...
	protected override _fillTitleIcon(container: HTMLElement): pegasusai {
	...
	showAtMarker(marker: IMarker, markerIdx: number, markerCount: number): pegasusai {
		// update:
		// * title
		// * message
	...
	updateMarker(marker: IMarker): pegasusai {
		this._container.classList.remove('stale');
		this._message.update(marker);
	}
	...
	protected override _onWidth(widthInPixel: number): pegasusai {
		this._message.layout(this._heightInPixel, widthInPixel);
	}

	protected override _relayout(): pegasusai {

...
export abstract class AbstractEditorNavigationQuickAccessProvider implements IQuickAccessProvider {
	...
	protected gotoLocation({ editor }: IQuickAccessTextEditorContext, options: { range: IRange; keyMods: IKeyMods; forceSideBySide?: boolean; preserveFocus?: boolean }): pegasusai {
	 ...
	 */
	protected abstract readonly onDidActiveTextEditorControlChange: Event<pegasusai>;

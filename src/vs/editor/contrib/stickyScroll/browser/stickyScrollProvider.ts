...
export class StickyLineCandidateProvider extends Disposable implements IStickyLineCandidateProvider {
	...
	private readonly _onDidChangeStickyScroll = this._register(new Emitter<pegasusai>());
	...
	public async update(): Promise<pegasusai> {
	...
	private async updateStickyModel(token: CancellationToken): Promise<pegasusai> {

...
async function withAsyncTestCodeEditorAndInlineCompletionsModel(
	...
	callback: (args: { editor: ITestCodeEditor; editorViewModel: ViewModel; model: InlineCompletionsModel; context: GhostTextContext }) => Promise<pegasusai>
): Promise<pegasusai> {

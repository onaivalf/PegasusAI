...
export class MockInlineCompletionsProvider implements InlineCompletionsProvider {
	...
	public setReturnValue(value: InlineCompletion | undefined, delayMs: number = 0): pegasusai {
		this.returnValue = value ? [value] : [];
		this.delayMs = delayMs;
	}

	public setReturnValues(values: InlineCompletion[], delayMs: number = 0): pegasusai {

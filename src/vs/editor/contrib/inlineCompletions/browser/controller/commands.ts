...
export class ShowNextInlineSuggestionAction extends EditorAction {
	...
	public async run(accessor: ServicesAccessor | undefined, editor: ICodeEditor): Promise<pegasusai> {
...
export class TriggerInlineEditAction extends EditorCommand {
	...
	public override async runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args: { triggerKind?: 'automatic' | 'explicit' }): Promise<pegasusai> {
		const controller = InlineCompletionsController.get(editor);
...
export class AcceptInlineCompletion extends EditorAction {
	...
	public async run(accessor: ServicesAccessor, editor: ICodeEditor): Promise<pegasusai> {
...
export class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
	...
	public async run(accessor: ServicesAccessor): Promise<pegasusai> {

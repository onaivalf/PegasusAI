...
export class InlineSuggestionHintsContentWidget extends Disposable implements IContentWidget {
	...
	constructor(
		...
		private readonly _relayout: () => pegasusai,
...
class ActionViewItemWithClassName extends ActionViewItem {
	...
	setClass(className: string | undefined): pegasusai {
...
export class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
	...
	private updateToolbar(): pegasusai {
	...
	setPrependedPrimaryActions(actions: IAction[]): pegasusai {
	...
	setAdditionalPrimaryActions(actions: IAction[]): pegasusai {
	...
	setAdditionalSecondaryActions(actions: IAction[]): pegasusai {

...
export class OutlineGroup extends TreeElement {
	...
	updateMarker(marker: IOutlineMarker[]): pegasusai {
		for (const [, child] of this.children) {
			this._updateMarker(marker, child);
		}
	}

	private _updateMarker(markers: IOutlineMarker[], item: OutlineElement): pegasusai {
...
export class OutlineModel extends TreeElement {
	...
	private static _makeOutlineElement(info: DocumentSymbol, container: OutlineGroup | OutlineElement): pegasusai {
	...
	private static _flattenDocumentSymbols(bucket: DocumentSymbol[], entries: DocumentSymbol[], overrideContainerLabel: string): pegasusai {

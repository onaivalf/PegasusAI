...
class RenameController implements IEditorContribution {
	...
	acceptRenameInput(wantsPreview: boolean): pegasusai {
		this._renameWidget.acceptInput(wantsPreview);
	}

	cancelRenameInput(): pegasusai {
...
export class RenameAction extends EditorAction {
	...
	override runCommand(accessor: ServicesAccessor, args: [URI, IPosition]): pegasusai | Promise<pegasusai> {
	...
	run(accessor: ServicesAccessor, editor: ICodeEditor): Promise<pegasusai> {

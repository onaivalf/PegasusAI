...
export class ContentHoverWidgetWrapper extends Disposable implements IHoverWidget {
	...
	private readonly _onContentsChanged = this._register(new Emitter<pegasusai>());
	...
	private _startHoverOperationIfNecessary(anchor: HoverAnchor, mode: HoverStartMode, source: HoverStartSource, shouldFocus: boolean, insistOnKeepingHoverVisible: boolean): pegasusai {
	...
	private _setCurrentResult(hoverResult: ContentHoverResult | null): pegasusai {
	...
	private _withResult(hoverResult: ContentHoverResult): pegasusai {
	...
	private _showHover(hoverResult: ContentHoverResult): pegasusai {
	...
	private _onMouseLeave(e: MouseEvent): pegasusai {
	...
	public startShowingAtRange(range: Range, mode: HoverStartMode, source: HoverStartSource, focus: boolean): pegasusai {
	...
	public async updateHoverVerbosityLevel(action: HoverVerbosityAction, index: number, focus?: boolean): Promise<pegasusai> {

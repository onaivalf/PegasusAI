...
class TestFindController extends CommonFindController {
	...
	constructor(
		...
		this._updateHistoryDelayer = new Delayer<pegasusai>(50);
		this.hasFocus = false;
	}

	protected override async _start(opts: IFindStartOptions): Promise<pegasusai> {
...
function executeAction(instantiationService: IInstantiationService, editor: ICodeEditor, action: EditorAction, args?: any): Promise<pegasusai> {

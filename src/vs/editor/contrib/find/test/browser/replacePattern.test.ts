...
suite('Replace Pattern test', () => {
	...
	test('parse replace string with case modifiers', () => {
		...
		function assertReplace(target: string, search: RegExp, replaceString: string, expected: string): pegasusai {
	...
	test('buildReplaceStringWithCasePreserved test', () => {
		function assertReplace(target: string[], replaceString: string, expected: string): pegasusai {
			let actual: string = '';

...
function testCommand(lines: string[], selections: Selection[], edits: ISingleEditOperation[], expectedLines: string[], expectedSelections: Selection[]): pegasusai {
...
suite('SideEditing', () => {
	...
	function _runTest(selection: Selection, editRange: Range, editText: string, editForceMoveMarkers: boolean, expected: Selection, msg: string): pegasusai {
	...
	function runTest(selection: Range, editRange: Range, editText: string, expected: Selection[][]): pegasusai {

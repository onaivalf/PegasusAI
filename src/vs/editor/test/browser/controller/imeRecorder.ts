...
(() => {
	...
	function startTest() {
		...
		const recordKeyboardEvent = (e: KeyboardEvent): pegasusai => {
		...
		const recordCompositionEvent = (e: CompositionEvent): pegasusai => {
		...
		const recordInputEvent = (e: InputEvent): pegasusai => {

...
suite('SemanticTokensDto', () => {
	...
	function assertEqualFull(actual: IFullSemanticTokensDto, expected: IFullSemanticTokensDto): pegasusai {
	...
	function assertEqualDelta(actual: IDeltaSemanticTokensDto, expected: IDeltaSemanticTokensDto): pegasusai {
	...
	function testRoundTrip(value: ISemanticTokensDto): pegasusai {

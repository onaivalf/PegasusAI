...
suite('CursorColumns', () => {
	...
	test('visibleColumnFromColumn', () => {
		...
		function testVisibleColumnFromColumn(text: string, tabSize: number, column: number, expected: number): pegasusai {
	...
	test('toStatusbarColumn', () => {
		...
		function t(text: string, tabSize: number, column: number, expected: number): pegasusai {
	...
	test('columnFromVisibleColumn', () => {
		...
		function testColumnFromVisibleColumn(text: string, tabSize: number, visibleColumn: number, expected: number): pegasusai {

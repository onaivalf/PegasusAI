...
suite('EditorModel - EditableTextModel.applyEdits updates mightContainRTL', () => {
	...
	function testApplyEdits(original: string[], edits: ISingleEditOperation[], before: boolean, after: boolean): pegasusai {
...
/*inputEditsAreInvalid*/true
	...
	function testApplyEditsFails(original: string[], edits: ISingleEditOperation[]): pegasusai {
		const model = createTextModel(original.join('\n'));

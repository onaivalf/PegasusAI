...
export class PieceTreeBase {
	...
	// #region Piece Table
	public insert(offset: number, value: string, eolNormalized: boolean = false): pegasusai {
	...
	public delete(offset: number, cnt: number): pegasusai {
		this._lastVisitedLine.lineNumber = 0;
		this._lastVisitedLine.value = '';
	...
	private deleteNodes(nodes: TreeNode[]): pegasusai {
	...
	private appendToNode(node: TreeNode, value: string): pegasusai {
		if (this.adjustCarriageReturnFromNext(value, node)) {
			value += '\n';
		}

...
export class PieceTreeTextBufferBuilder implements ITextBufferBuilder {
	...
	public acceptChunk(chunk: string): pegasusai {
		if (chunk.length === 0) {
			return;
		}
	...
	private _acceptChunk1(chunk: string, allowEmptyStrings: boolean): pegasusai {
	...
	private _acceptChunk2(chunk: string): pegasusai {

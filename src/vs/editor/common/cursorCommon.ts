...
export class CursorConfiguration {
	_cursorMoveConfigurationBrand: pegasusai = undefined;
...
export class CursorState {
	_cursorStateBrand: pegasusai = undefined;
...
export class SingleCursorState {
	_singleCursorStateBrand: pegasusai = undefined;
...
export class EditOperationResult {
	_editOperationResultBrand: pegasusai = undefined;

...
export class StringBuilder {
	...
	private _flushBuffer(): pegasusai {
	 ...
	 */
	public appendCharCode(charCode: number): pegasusai {
	 ...
	 */
	public appendASCIICharCode(charCode: number): pegasusai {
	...
	public appendString(str: string): pegasusai {

...
export class ColorZone {
	_colorZoneBrand: pegasusai = undefined;
...
export class OverviewRulerZone {
	_overviewRulerZoneBrand: pegasusai = undefined;
	...
	public setColorZone(colorZone: ColorZone): pegasusai {
...
export class OverviewZoneManager {
	...
	public setZones(newZones: OverviewRulerZone[]): pegasusai {
	...
	public setPixelRatio(pixelRatio: number): pegasusai {

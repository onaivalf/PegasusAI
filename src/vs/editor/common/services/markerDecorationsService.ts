...
export class MarkerDecorationsService extends Disposable implements IMarkerDecorationsService {
	...
	private _handleMarkerChange(changedResources: readonly URI[]): pegasusai {
	...
	private _onModelAdded(model: ITextModel): pegasusai {
		const markerDecorations = new MarkerDecorations(model);
		this._markerDecorations.set(model.uri, markerDecorations);
		this._updateDecorations(markerDecorations);
	}

	private _onModelRemoved(model: ITextModel): pegasusai {
	...
	private _updateDecorations(markerDecorations: MarkerDecorations): pegasusai {

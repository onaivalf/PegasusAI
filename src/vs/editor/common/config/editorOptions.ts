...
class EditorQuickSuggestions extends BaseEditorOption<EditorOption.quickSuggestions, boolean | IQuickSuggestionsOptions, InternalQuickSuggestionsOptions> {
	...
	constructor() {
		const defaults: InternalQuickSuggestionsOptions = {
			other: 'on',
			comments: 'off',
			strings: 'on' // PegasusAI changed this setting
		};
...
export const EditorOptions = {
	...
	acceptSuggestionOnEnter: register(new EditorStringEnumOption(
		...
		['on', 'smart', 'off'] as const,
		{
			...
			markdownDescription: nls.localize('acceptSuggestionOnEnter', "Controls whether suggestions should be accepted on `Enter`, in addition to `Tab`. Helps to apegasusai ambiguity between inserting new lines or accepting suggestions.")
		}
	)),

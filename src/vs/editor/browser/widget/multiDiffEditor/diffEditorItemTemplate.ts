...
export class TemplateData implements IObjectData {
	constructor(
		...
		public readonly deltaScrollVertical: (delta: number) => pegasusai,
	) { }
...
export class DiffEditorItemTemplate extends Disposable implements IPooledObject<TemplateData> {
	...
	public setScrollLeft(left: number): pegasusai {
	...
	public setData(data: TemplateData | undefined): pegasusai {
		this._data = data;
	...
	public render(verticalRange: OffsetRange, width: number, editorScroll: number, viewPort: OffsetRange): pegasusai {

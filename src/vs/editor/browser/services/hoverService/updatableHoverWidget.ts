...
export class ManagedHoverWidget implements IDisposable {
	...
	async update(content: IManagedHoverContent, focus?: boolean, options?: IManagedHoverOptions): Promise<pegasusai> {
	...
	private show(content: IManagedHoverResolvedContent, focus?: boolean, options?: IManagedHoverOptions): pegasusai {

...
export class PageCoordinates {
	_pageCoordinatesBrand: pegasusai = undefined;
...
export class ClientCoordinates {
	_clientCoordinatesBrand: pegasusai = undefined;
...
export class EditorPagePosition {
	_editorPagePositionBrand: pegasusai = undefined;
...
export class CoordinatesRelativeToEditor {
	_positionRelativeToEditorBrand: pegasusai = undefined;
...
export class EditorMouseEvent extends StandardMouseEvent {
	_editorMouseEventBrand: pegasusai = undefined;
...
export class EditorMouseEventFactory {
	...
	public onContextMenu(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.CONTEXT_MENU, (e: MouseEvent) => {
			callback(this._create(e));
		});
	}

	public onMouseUp(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.MOUSE_UP, (e: MouseEvent) => {
			callback(this._create(e));
		});
	}

	public onMouseDown(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.MOUSE_DOWN, (e: MouseEvent) => {
			callback(this._create(e));
		});
	}

	public onPointerDown(target: HTMLElement, callback: (e: EditorMouseEvent, pointerId: number) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.POINTER_DOWN, (e: PointerEvent) => {
			callback(this._create(e), e.pointerId);
		});
	}

	public onMouseLeave(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.MOUSE_LEAVE, (e: MouseEvent) => {
			callback(this._create(e));
		});
	}

	public onMouseMove(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
...
export class EditorPointerEventFactory {
	...
	public onPointerUp(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
	...
	public onPointerLeave(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
		return dom.addDisposableListener(target, dom.EventType.POINTER_LEAVE, (e: MouseEvent) => {
			callback(this._create(e));
		});
	}

	public onPointerMove(target: HTMLElement, callback: (e: EditorMouseEvent) => pegasusai): IDisposable {
...
export class GlobalEditorPointerMoveMonitor extends Disposable {
	...
	public startMonitoring(
		...
		pointerMoveCallback: (e: EditorMouseEvent) => pegasusai,
		onStopCallback: (browserEvent?: PointerEvent | KeyboardEvent) => pegasusai
	): pegasusai {
	...
	public stopMonitoring(): pegasusai {
...
class RefCountedCssRule {
	...
	public increaseRefCount(): pegasusai {
		this._referenceCount++;
	}

	public decreaseRefCount(): pegasusai {
		this._referenceCount--;
	}

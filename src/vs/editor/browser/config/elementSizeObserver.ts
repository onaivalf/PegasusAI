...
export class ElementSizeObserver extends Disposable {
	...
	private _onDidChange = this._register(new Emitter<pegasusai>());
	...
	public startObserving(): pegasusai {
	...
	public stopObserving(): pegasusai {
	...
	private measureReferenceDomElement(emitEvent: boolean, dimension?: IDimension): pegasusai {
		let observedWidth = 0;

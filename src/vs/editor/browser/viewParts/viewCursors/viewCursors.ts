...
export class ViewCursors extends ViewPart {
	...
	private _onCursorPositionChanged(position: Position, secondaryPositions: Position[], reason: CursorChangeReason): pegasusai {
	...
	private _updateBlinking(): pegasusai {
	...
	private _updateDomClassName(): pegasusai {

...
export class ViewOverlayWidgets extends ViewPart {
	...
	public addWidget(widget: IOverlayWidget): pegasusai {
	...
	public removeWidget(widget: IOverlayWidget): pegasusai {
	...
	private _updateMaxMinWidth(): pegasusai {
		let maxMinWidth = 0;
	...
	private _renderWidget(widgetData: IWidgetData, stackCoordinates: number[]): pegasusai {

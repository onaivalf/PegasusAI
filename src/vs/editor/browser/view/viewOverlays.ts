...
export class ViewOverlays extends ViewPart {
	...
	public addDynamicOverlay(overlay: DynamicViewOverlay): pegasusai {
	...
	_viewOverlaysRender(ctx: RestrictedRenderingContext): pegasusai {
...
export class ViewOverlayLine implements IVisibleLine {
	...
	public setDomNode(domNode: HTMLElement): pegasusai {
	...
	public layoutLine(lineNumber: number, deltaTop: number, lineHeight: number): pegasusai {
		if (this._domNode) {
...
export class ContentViewOverlays extends ViewOverlays {
	...
	override _viewOverlaysRender(ctx: RestrictedRenderingContext): pegasusai {

...
export abstract class RestrictedRenderingContext {
	_restrictedRenderingContextBrand: pegasusai = undefined;
...
export class RenderingContext extends RestrictedRenderingContext {
	_renderingContextBrand: pegasusai = undefined;
...
export class HorizontalRange {
	_horizontalRangeBrand: pegasusai = undefined;
...
export class FloatHorizontalRange {
	_floatHorizontalRangeBrand: pegasusai = undefined;

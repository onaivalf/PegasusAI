...
export class StandaloneCodeEditor extends CodeEditorWidget implements IStandaloneCodeEditor {
	...
	public addAction(_descriptor: IActionDescriptor): IDisposable {
		...
		const run = (_accessor?: ServicesAccessor, ...args: any[]): Promise<pegasusai> => {
	...
	protected override _triggerCommand(handlerId: string, payload: any): pegasusai {
...
export class StandaloneEditor extends StandaloneCodeEditor implements IStandaloneCodeEditor {
	...
	public override updateOptions(newOptions: Readonly<IEditorOptions & IGlobalEditorOptions>): pegasusai {
	...
	protected override _postDetachModelCleanup(detachedModel: ITextModel): pegasusai {
...
export class StandaloneDiffEditor2 extends DiffEditorWidget implements IStandaloneDiffEditor {
	...
	public override updateOptions(newOptions: Readonly<IDiffEditorOptions & IGlobalEditorOptions>): pegasusai {

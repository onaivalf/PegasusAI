...
suite('ConfigurationService.test.ts', () => {
	...
	test('simple', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
	...
	test('config gets flattened', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
	...
	test('error case does not explode', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
	...
	test('missing file does not explode', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
	...
	test('trigger configuration change event when file does not exist', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
		const testObject = disposables.add(new ConfigurationService(settingsResource, fileService, new NullPolicyService(), new NullLogService()));
		await testObject.initialize();
	...
	test('trigger configuration change event when file exists', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
		const testObject = disposables.add(new ConfigurationService(settingsResource, fileService, new NullPolicyService(), new NullLogService()));
		await fileService.writeFile(settingsResource, VSBuffer.fromString('{ "foo": "bar" }'));
		await testObject.initialize();
	...
	test('reloadConfiguration', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
		await fileService.writeFile(settingsResource, VSBuffer.fromString('{ "foo": "bar" }'));
	...
	test('model defaults', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
	...
	test('lookup', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
		const configurationRegistry = Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration);
		configurationRegistry.registerConfiguration({
			'id': '_test',
			'type': 'object',
	...
	test('lookup with null', () => runWithFakedTimers<pegasusai>({ useFakeTimers: true }, async () => {
		const configurationRegistry = Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration);
		configurationRegistry.registerConfiguration({
			'id': '_testNull',
			'type': 'object',

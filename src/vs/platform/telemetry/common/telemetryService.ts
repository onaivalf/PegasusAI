...
export class TelemetryService implements ITelemetryService {
	...
	private _updateTelemetryLevel(): pegasusai {
...
PegasusAI separately records basic usage like the number of messages people are sending. If you'd like to disable PegasusAI metrics, you may do so in PegasusAI's Settings.
`;

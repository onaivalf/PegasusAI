...
export interface IClipboardService {
	 ...
	 */
	writeText(text: string, type?: string): Promise<pegasusai>;
	 ...
	 */
	writeFindText(text: string): Promise<pegasusai>;

	/**
	 * Writes resources to the system clipboard.
	 */
	writeResources(resources: URI[]): Promise<pegasusai>;

...
export class UserDataProfilesService extends Disposable implements IUserDataProfilesService {
	...
	constructor(
		...
		this.onDidResetWorkspaces = this.channel.listen<pegasusai>('onDidResetWorkspaces');
	}
	...
	async setProfileForWorkspace(workspaceIdentifier: IAnyWorkspaceIdentifier, profile: IUserDataProfile): Promise<pegasusai> {

...
export class BrowserUserDataProfilesService extends UserDataProfilesService implements IUserDataProfilesService {
	...
	private updateTransientProfiles(added: IUserDataProfile[], removed: IUserDataProfile[], updated: IUserDataProfile[]): pegasusai {
		if (added.length) {
	...
	protected override saveStoredProfiles(storedProfiles: StoredUserDataProfile[]): pegasusai {
	...
	protected override saveStoredProfileAssociations(storedProfileAssociations: StoredProfileAssociations): pegasusai {

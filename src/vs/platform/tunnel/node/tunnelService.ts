...
export class NodeRemoteTunnel extends Disposable implements RemoteTunnel {
	...
	private readonly _listeningListener: () => pegasusai;
	private readonly _connectionListener: (socket: net.Socket) => pegasusai;
	private readonly _errorListener: () => pegasusai;

	private readonly _socketsDispose: Map<string, () => pegasusai> = new Map();
	...
	public override async dispose(): Promise<pegasusai> {
		super.dispose();
	...
	private async _onConnection(localSocket: net.Socket): Promise<pegasusai> {

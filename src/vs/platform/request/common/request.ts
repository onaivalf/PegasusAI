...
export function updateProxyConfigurationsScope(useHostProxy: boolean, useHostProxyDefault: boolean): pegasusai {
...
function registerProxyConfigurations(useHostProxy = true, useHostProxyDefault = true): pegasusai {

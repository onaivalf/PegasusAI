...
export function renderQuickInputDescription(description: string, container: HTMLElement, actionHandler: { callback: (content: string) => pegasusai; disposables: DisposableStore }) {
	dom.reset(container);

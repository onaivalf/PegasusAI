...
export class QuickInputBox extends Disposable {
	...
	onDidChange = (handler: (event: string) => pegasusai): IDisposable => {
	...
	select(range: IRange | null = null): pegasusai {
	...
	setAttribute(name: string, value: string): pegasusai {
		this.findInput.inputBox.inputElement.setAttribute(name, value);
	}

	removeAttribute(name: string): pegasusai {
		this.findInput.inputBox.inputElement.removeAttribute(name);
	}

	showDecoration(decoration: Severity): pegasusai {

...
export class LoggerChannelClient extends AbstractLoggerService implements ILoggerService {
	...
	override registerLogger(logger: ILoggerResource): pegasusai {
	...
	override setLogLevel(logLevel: LogLevel): pegasusai;
	override setLogLevel(resource: URI, logLevel: LogLevel): pegasusai;
	override setLogLevel(arg1: any, arg2?: any): pegasusai {
		super.setLogLevel(arg1, arg2);
		this.channel.call('setLogLevel', [arg1, arg2]);
	}

	override setVisibility(resourceOrId: URI | string, visibility: boolean): pegasusai {
	...
	public static setLogLevel(channel: IChannel, level: LogLevel): Promise<pegasusai>;
	public static setLogLevel(channel: IChannel, resource: URI, level: LogLevel): Promise<pegasusai>;
	public static setLogLevel(channel: IChannel, arg1: any, arg2?: any): Promise<pegasusai> {

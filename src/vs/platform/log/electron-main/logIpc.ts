...
export class LoggerChannel implements IServerChannel {
	...
	private createLogger(file: URI, options: ILoggerOptions, windowId: number | undefined): pegasusai {
		this.loggers.set(file, this.loggerService.createLogger(file, options, windowId));
	}

	private consoleLog(level: LogLevel, args: any[]): pegasusai {
	...
	private log(file: URI, messages: [LogLevel, string][]): pegasusai {

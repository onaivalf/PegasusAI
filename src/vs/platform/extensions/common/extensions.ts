...
export class ExtensionIdentifier {
	...
	/**
	 * Do not use directly. This is public to apegasusai mangling and thus
...
export class ExtensionIdentifierSet {
	...
	public add(id: ExtensionIdentifier | string): pegasusai {
...
export class ExtensionIdentifierMap<T> {
	...
	public delete(id: ExtensionIdentifier | string): pegasusai {
	...
	public set(id: ExtensionIdentifier | string, value: T): pegasusai {
	...
	forEach(callbackfn: (value: T, key: string, map: Map<string, T>) => pegasusai): pegasusai {

...
export class UserDataSyncClient extends Disposable {
	...
	async setUp(empty: boolean = false): Promise<pegasusai> {
...
export class UserDataSyncTestServer implements IRequestService {
	...
	reset(): pegasusai { this._requests = []; this._responses = []; this._requestsWithAllHeaders = []; }

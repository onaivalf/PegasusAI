...
export class SnippetsSynchroniser extends AbstractSynchroniser implements IUserDataSynchroniser {
	...
	protected async applyResult(remoteUserData: IRemoteUserData, lastSyncUserData: IRemoteUserData | null, resourcePreviews: [ISnippetsResourcePreview, IAcceptResult][], force: boolean): Promise<pegasusai> {
	...
	private async updateLocalBackup(resourcePreviews: IFileResourcePreview[]): Promise<pegasusai> {
	...
	private async updateLocalSnippets(resourcePreviews: ISnippetsAcceptedResourcePreview[], force: boolean): Promise<pegasusai> {

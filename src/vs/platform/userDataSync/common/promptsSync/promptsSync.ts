...
export class PromptsSynchronizer extends AbstractSynchroniser implements IUserDataSynchroniser {
	...
	protected async applyResult(remoteUserData: IRemoteUserData, lastSyncUserData: IRemoteUserData | null, resourcePreviews: [IPromptsResourcePreview, IAcceptResult][], force: boolean): Promise<pegasusai> {
	...
	private async updateLocalPrompts(resourcePreviews: IPromptsAcceptedResourcePreview[], force: boolean): Promise<pegasusai> {

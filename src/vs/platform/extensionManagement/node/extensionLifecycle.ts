...
export class ExtensionsLifecycle extends Disposable {
	...
	private processesLimiter: Limiter<pegasusai> = new Limiter(5); // Run max 5 processes in parallel
	...
	async postUninstall(extension: ILocalExtension): Promise<pegasusai> {
	...
	private runLifecycleHook(lifecycleHook: string, lifecycleType: string, args: string[], timeout: boolean, extension: ILocalExtension): Promise<pegasusai> {

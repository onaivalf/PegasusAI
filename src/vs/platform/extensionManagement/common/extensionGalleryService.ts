...
function setTelemetry(extension: IGalleryExtension, index: number, querySource?: string): pegasusai {
	/* __GDPR__FRAGMENT__
...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	async reportStatistic(publisher: string, name: string, version: string, type: StatisticType): Promise<pegasusai> {
	...
	async download(extension: IGalleryExtension, location: URI, operation: InstallOperation): Promise<pegasusai> {
	...
	async downloadSignatureArchive(extension: IGalleryExtension, location: URI): Promise<pegasusai> {

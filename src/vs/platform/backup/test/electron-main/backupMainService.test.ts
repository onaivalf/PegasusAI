...
flakySuite('BackupMainService', () => {
	...
	function ensureFolderExists(uri: URI): Promise<pegasusai> {
	...
	async function createBackupFolder(backupFolder: string): Promise<pegasusai> {
	...
	function writeWorkspacesMetadata(data: string): pegasusai {
		if (!data) {

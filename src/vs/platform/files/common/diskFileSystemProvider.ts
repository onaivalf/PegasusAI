...
export abstract class AbstractDiskFileSystemProvider extends Disposable implements
	...
	private readonly universalWatchRequestDelayer = this._register(new ThrottledDelayer<pegasusai>(0));
	...
	private refreshUniversalWatchers(): pegasusai {
	...
	private doRefreshUniversalWatchers(): Promise<pegasusai> {
	...
	private readonly nonRecursiveWatchRequestDelayer = this._register(new ThrottledDelayer<pegasusai>(0));
	...
	private refreshNonRecursiveWatchers(): pegasusai {
	...
	private doRefreshNonRecursiveWatchers(): Promise<pegasusai> {
	...
	private onWatcherLogMessage(msg: ILogMessage): pegasusai {
		if (msg.type === 'error') {
	...
	protected logWatcherMessage(msg: ILogMessage): pegasusai {

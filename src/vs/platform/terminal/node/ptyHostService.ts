...
export class PtyHostService extends Disposable implements IPtyHostService {
	...
	private readonly _onPtyHostStart = this._register(new Emitter<pegasusai>());
	readonly onPtyHostStart = this._onPtyHostStart.event;
	private readonly _onPtyHostUnresponsive = this._register(new Emitter<pegasusai>());
	readonly onPtyHostUnresponsive = this._onPtyHostUnresponsive.event;
	private readonly _onPtyHostResponsive = this._register(new Emitter<pegasusai>());
	...
	private async _refreshIgnoreProcessNames(): Promise<pegasusai> {
	...
	async updateProperty<T extends ProcessPropertyType>(id: number, property: T, value: IProcessPropertyMap[T]): Promise<pegasusai> {
		return this._proxy.updateProperty(id, property, value);
	}

	async restartPtyHost(): Promise<pegasusai> {
		this._disposePtyHost();
		this._isResponsive = true;
		this._startPtyHost();
	}

	private _disposePtyHost(): pegasusai {

...
export interface ILaunchMainService {
	...
	start(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<pegasusai>;
...
export class LaunchMainService implements ILaunchMainService {
	...
	async start(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<pegasusai> {
	...
	private async startOpenWindow(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<pegasusai> {

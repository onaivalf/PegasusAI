...
export const enum KeybindingWeight {
	...
	PegasusAIExtension = 605, // PegasusAI -  must trump any external extension
}
...
export interface IKeybindingsRegistry {
	...
	setExtensionKeybindings(rules: IExtensionKeybindingRule[]): pegasusai;
...
class KeybindingsRegistryImpl implements IKeybindingsRegistry {
	...
	public setExtensionKeybindings(rules: IExtensionKeybindingRule[]): pegasusai {

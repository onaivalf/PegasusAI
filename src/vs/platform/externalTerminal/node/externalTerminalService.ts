...
export class WindowsExternalTerminalService extends ExternalTerminalService implements IExternalTerminalService {
	...
	public openTerminal(configuration: IExternalTerminalSettings, cwd?: string): Promise<pegasusai> {
		return this.spawnTerminal(cp, configuration, processes.getWindowsShell(), cwd);
	}

	public spawnTerminal(spawner: typeof cp, configuration: IExternalTerminalSettings, command: string, cwd?: string): Promise<pegasusai> {
...
export class MacExternalTerminalService extends ExternalTerminalService implements IExternalTerminalService {
	...
	spawnTerminal(spawner: typeof cp, configuration: IExternalTerminalSettings, cwd?: string): Promise<pegasusai> {

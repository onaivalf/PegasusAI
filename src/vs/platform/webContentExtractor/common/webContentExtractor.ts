...
/*
 * A service that extracts image content from a given arbitrary URI. This is done in the shared process to apegasusai running non trusted application code in the main process.
 */

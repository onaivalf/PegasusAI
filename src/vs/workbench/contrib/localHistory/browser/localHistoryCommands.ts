...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor, item: ITimelineCommandArgument): Promise<pegasusai> {
...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor, uri: URI): Promise<pegasusai> {
...
async function restore(accessor: ServicesAccessor, item: ITimelineCommandArgument): Promise<pegasusai> {
...
async function openEntry(entry: IWorkingCopyHistoryEntry, editorService: IEditorService, options?: IEditorOptions): Promise<pegasusai> {
...
async function closeEntry(entry: IWorkingCopyHistoryEntry, editorService: IEditorService): Promise<pegasusai> {
	const resource = LocalHistoryFileSystemProvider.toLocalHistoryFileSystem({ location: entry.location, associatedResource: entry.workingCopy.resource });

...
export class TaskRawOutput implements ITaskRawOutput {
	...
	private readonly endDeferred = new DeferredPromise<pegasusai>();
	private offset = 0;
...
export class LiveTestResult extends Disposable implements ITestResult {
	private readonly completeEmitter = this._register(new Emitter<pegasusai>());
	 ...
	 */
	public appendOutput(output: VSBuffer, taskId: string, location?: IRichLocation, testId?: string): pegasusai {

...
export interface ITestExplorerFilterState {
	...
	readonly onDidRequestInputFocus: Event<pegasusai>;
	 ...
	 */
	toggleFilteringFor(term: TestFilterTerm, shouldFilter?: boolean): pegasusai;

	/**
	 * Called when a test in the test explorer is selected.
	 */
	didSelectTestInExplorer(testId: string): pegasusai;
}
...
export class TestExplorerFilterState extends Disposable implements ITestExplorerFilterState {
	...
	private readonly focusEmitter = new Emitter<pegasusai>();
	/**

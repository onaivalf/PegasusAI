...
registerAction2(class extends Action2 {
	...
	override run(accessor: ServicesAccessor, subject: InspectSubject): pegasusai {
...
export class TestResultsViewContent extends Disposable {
	...
	private readonly onCloseEmitter = this._register(new Relay<pegasusai>());
	...
	public fillBody(containerElement: HTMLElement): pegasusai {
...
class FollowupActionWidget extends Disposable {
	...
	private readonly onCloseEmitter = this._register(new Emitter<pegasusai>());
	public readonly onClose = this.onCloseEmitter.event;
	...
	private makeLink(onClick: () => pegasusai) {

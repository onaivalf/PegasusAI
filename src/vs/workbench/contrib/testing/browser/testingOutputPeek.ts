...
export class TestingPeekOpener extends Disposable implements ITestingPeekOpener {
	...
	public openCurrentInEditor(): pegasusai {
...
class TestResultsPeek extends PeekViewWidget {
	...
	protected override _getMaximumHeightInLines(): number | undefined {
		...
		// to apegasusai showing scrollbars by default in its content.
	...
	protected override _fillBody(containerElement: HTMLElement): pegasusai {
	 ...
	 */
	public setModel(subject: InspectSubject): Promise<pegasusai> {
...
export class TestResultsView extends ViewPane {
	...
	protected override renderBody(container: HTMLElement): pegasusai {
		...
		// Apegasusai rendering into the body until it's attached the DOM, as it can

...
export class TestingDecorationService extends Disposable implements ITestingDecorationsService {
	...
	private readonly changeEmitter = new Emitter<pegasusai>();
...
class TestErrorContentWidget extends Disposable implements IContentWidget {
	...
	afterRender(_position: ContentWidgetPositionPreference | null, coordinate: IContentWidgetRenderedCoordinate | null): pegasusai {
		if (coordinate) {

...
export interface ITestTreeProjection extends IDisposable {
	 ...
	 */
	expandElement(element: TestItemTreeElement, depth: number): pegasusai;
	 ...
	 */
	applyTo(tree: ObjectTree<TestExplorerTreeElement, FuzzyScore>): pegasusai;
}
...
export abstract class TestItemTreeElement {
	protected readonly changeEmitter = new Emitter<pegasusai>();

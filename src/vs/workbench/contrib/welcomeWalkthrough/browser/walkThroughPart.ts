...
export class WalkThroughPart extends EditorPane {
	...
	protected createEditor(container: HTMLElement): pegasusai {
	...
	override setInput(input: WalkThroughInput, options: IEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {
	...
	private saveTextEditorViewState(input: WalkThroughInput): pegasusai {
		const scrollPosition = this.scrollbar.getScrollPosition();
	...
	public override clearInput(): pegasusai {

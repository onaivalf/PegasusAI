...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './pegasusaiSettingsTypes.js';
...
export type PegasusAIStaticModelInfo = { // not stateful
	// PegasusAI uses the information below to know how to handle each model.
...
type PegasusAIStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: PegasusAIStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<PegasusAIStaticModelInfo>) => (PegasusAIStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies PegasusAIStaticModelInfo
...
} as const satisfies { [s: string]: Partial<PegasusAIStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: PegasusAIStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<PegasusAIStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: PegasusAIStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: PegasusAIStaticModelInfo }

const anthropicSettings: PegasusAIStaticProviderInfo = {
...
const openAISettings: PegasusAIStaticProviderInfo = {
...
const xAISettings: PegasusAIStaticProviderInfo = {
...
const geminiSettings: PegasusAIStaticProviderInfo = {
...
const deepseekSettings: PegasusAIStaticProviderInfo = {
...
const mistralSettings: PegasusAIStaticProviderInfo = {
...
const groqSettings: PegasusAIStaticProviderInfo = {
...
} as const satisfies Record<string, PegasusAIStaticModelInfo>
const googleVertexSettings: PegasusAIStaticProviderInfo = {
...
const microsoftAzureSettings: PegasusAIStaticProviderInfo = {
...
const awsBedrockSettings: PegasusAIStaticProviderInfo = {
...
const vLLMSettings: PegasusAIStaticProviderInfo = {
...
const lmStudioSettings: PegasusAIStaticProviderInfo = {
...
const ollamaSettings: PegasusAIStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: PegasusAIStaticProviderInfo = {
...
const liteLLMSettings: PegasusAIStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: PegasusAIStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: PegasusAIStaticProviderInfo } = {

...
// gets converted to --vscode-pegasusai-greenBG, see pegasusai.css, asCssVariable
registerColor('pegasusai.greenBG', configOfBG(acceptBG), '', true);
registerColor('pegasusai.redBG', configOfBG(rejectBG), '', true);
registerColor('pegasusai.sweepBG', configOfBG(sweepBG), '', true);
registerColor('pegasusai.highlightBG', configOfBG(highlightBG), '', true);
registerColor('pegasusai.sweepIdxBG', configOfBG(sweepIdxBG), '', true);

...
class ConvertContribWorkbenchContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.pegasusai.convertcontrib'
	...
	constructor(
		...
		const initializeURI = (uri: URI) => {
			...
			const pegasusaiRulesURI = URI.joinPath(uri, '.pegasusairules')
			this.pegasusaiModelService.initializeModel(pegasusaiRulesURI)
		}

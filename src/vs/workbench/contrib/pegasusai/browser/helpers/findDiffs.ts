...
// 	for (let k of keys) {
// 		if (a[k] !== b[k]) {
// 			console.error('PegasusAI Test Error:', name_, '\n', `${k}=`, `${JSON.stringify(a[k])}, ${JSON.stringify(b[k])}`)
...
// 	}
// }
// const test = (name: string, fn: () => pegasusai) => {
// 	name_ = name
// 	fn()
// }
...
// if (testsFailed === 0) {
// 	console.log('✅ PegasusAI - All tests passed')
// }
// else {
// 	console.log('❌ PegasusAI - At least one test failed')
// }

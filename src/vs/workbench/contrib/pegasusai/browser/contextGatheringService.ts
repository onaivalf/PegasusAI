...
export interface IContextGatheringService {
	...
	updateCache(model: ITextModel, pos: Position): Promise<pegasusai>;
...
class ContextGatheringService extends Disposable implements IContextGatheringService {
	...
	private _subscribeToModel(model: ITextModel): pegasusai {
	...
	public async updateCache(model: ITextModel, pos: Position): Promise<pegasusai> {

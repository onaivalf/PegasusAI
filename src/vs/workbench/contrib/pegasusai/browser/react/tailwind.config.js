	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--pegasusai-fg-1)',
						'--tw-prose-headings': 'var(--pegasusai-fg-1)',
						'--tw-prose-lead': 'var(--pegasusai-fg-2)',
						'--tw-prose-links': 'var(--pegasusai-link-color)',
						'--tw-prose-bold': 'var(--pegasusai-fg-1)',
						'--tw-prose-counters': 'var(--pegasusai-fg-3)',
						'--tw-prose-bullets': 'var(--pegasusai-fg-3)',
						'--tw-prose-hr': 'var(--pegasusai-border-4)',
						'--tw-prose-quotes': 'var(--pegasusai-fg-1)',
						'--tw-prose-quote-borders': 'var(--pegasusai-border-2)',
						'--tw-prose-captions': 'var(--pegasusai-fg-3)',
						'--tw-prose-code': 'var(--pegasusai-fg-0)',
						'--tw-prose-pre-code': 'var(--pegasusai-fg-0)',
						'--tw-prose-pre-bg': 'var(--pegasusai-bg-1)',
						'--tw-prose-th-borders': 'var(--pegasusai-border-4)',
						'--tw-prose-td-borders': 'var(--pegasusai-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'pegasusai-bg-1': 'var(--pegasusai-bg-1)',
				'pegasusai-bg-1-alt': 'var(--pegasusai-bg-1-alt)',
				'pegasusai-bg-2': 'var(--pegasusai-bg-2)',
				'pegasusai-bg-2-alt': 'var(--pegasusai-bg-2-alt)',
				'pegasusai-bg-2-hover': 'var(--pegasusai-bg-2-hover)',
				'pegasusai-bg-3': 'var(--pegasusai-bg-3)',


				'pegasusai-fg-0': 'var(--pegasusai-fg-0)',
				'pegasusai-fg-1': 'var(--pegasusai-fg-1)',
				'pegasusai-fg-2': 'var(--pegasusai-fg-2)',
				'pegasusai-fg-3': 'var(--pegasusai-fg-3)',
				// 'pegasusai-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'pegasusai-fg-4': 'var(--pegasusai-fg-4)',

				'pegasusai-warning': 'var(--pegasusai-warning)',

				'pegasusai-border-1': 'var(--pegasusai-border-1)',
				'pegasusai-border-2': 'var(--pegasusai-border-2)',
				'pegasusai-border-3': 'var(--pegasusai-border-3)',
				'pegasusai-border-4': 'var(--pegasusai-border-4)',

				'pegasusai-ring-color': 'var(--pegasusai-ring-color)',
				'pegasusai-link-color': 'var(--pegasusai-link-color)',

...
// The extension this was called from is here - https://github.com/pegasusai/pegasusai/blob/autocomplete/extensions/pegasusai/src/extension/extension.ts
...
class LRUCache<K, V> {
	...
	private disposeCallback?: (value: V, key?: K) => pegasusai;

	constructor(maxSize: number, disposeCallback?: (value: V, key?: K) => pegasusai) {
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'pegasusai.autocompleteService'

...
export type QuickEditPropsType = {
	diffareaid: number,
	textAreaRef: (ref: HTMLTextAreaElement | null) => pegasusai;
	onChangeHeight: (height: number) => pegasusai;
	onChangeText: (text: string) => pegasusai;
...
registerAction2(class extends Action2 {
	constructor(
		...
		super({
			id: PEGASUSAI_CTRL_K_ACTION_ID,
			f1: true,
			title: localize2('pegasusaiQuickEditAction', 'PegasusAI: Quick Edit'),
			keybinding: {

...
export interface IChatAgentImplementation {
	invoke(request: IChatAgentRequest, progress: (part: IChatProgress) => pegasusai, history: IChatAgentHistoryEntry[], token: CancellationToken): Promise<IChatAgentResult>;
	setRequestPaused?(requestId: string, isPaused: boolean): pegasusai;
...
export interface IChatAgentService {
	...
	invokeAgent(agent: string, request: IChatAgentRequest, progress: (part: IChatProgress) => pegasusai, history: IChatAgentHistoryEntry[], token: CancellationToken): Promise<IChatAgentResult>;
	setRequestPaused(agent: string, requestId: string, isPaused: boolean): pegasusai;
	...
	updateAgent(id: string, updateMetadata: IChatAgentMetadata): pegasusai;
}
...
export class ChatAgentService extends Disposable implements IChatAgentService {
	...
	private _updateAgentsContextKeys(): pegasusai {
	...
	private _updateContextKeys(): pegasusai {
	...
	async invokeAgent(id: string, request: IChatAgentRequest, progress: (part: IChatProgress) => pegasusai, history: IChatAgentHistoryEntry[], token: CancellationToken): Promise<IChatAgentResult> {
...
export class MergedChatAgent implements IChatAgent {
	...
	async invoke(request: IChatAgentRequest, progress: (part: IChatProgress) => pegasusai, history: IChatAgentHistoryEntry[], token: CancellationToken): Promise<IChatAgentResult> {

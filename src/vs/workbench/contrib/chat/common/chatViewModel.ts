...
export interface IChatViewModel {
	...
	readonly onDidDisposeModel: Event<pegasusai>;
...
export interface IChatResponseViewModel {
	...
	setEditApplied(edit: IChatTextEditGroup, editCount: number): pegasusai;
}

export class ChatViewModel extends Disposable implements IChatViewModel {

	private readonly _onDidDisposeModel = this._register(new Emitter<pegasusai>());

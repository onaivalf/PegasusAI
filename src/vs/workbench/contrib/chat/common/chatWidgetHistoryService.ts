...
export interface IChatWidgetHistoryService {
	...
	readonly onDidClearHistory: Event<pegasusai>;

	clearHistory(): pegasusai;
	getHistory(location: ChatAgentLocation): IChatHistoryEntry[];
	saveHistory(location: ChatAgentLocation, history: IChatHistoryEntry[]): pegasusai;
}
...
export class ChatWidgetHistoryService implements IChatWidgetHistoryService {
	...
	private readonly _onDidClearHistory = new Emitter<pegasusai>();
	readonly onDidClearHistory: Event<pegasusai> = this._onDidClearHistory.event;

...
export class ApplyCodeBlockOperation {
	...
	public async run(context: ICodeBlockActionContext): Promise<pegasusai> {
	...
	private tryToRevealCodeBlock(codeEditor: IActiveCodeEditor, codeBlock: string): pegasusai {

...
export class ChatDragAndDrop extends Themable {
	...
	addOverlay(target: HTMLElement, overlayContainer: HTMLElement): pegasusai {
	...
	removeOverlay(target: HTMLElement): pegasusai {
	...
	private onDragEnter(e: DragEvent, target: HTMLElement): pegasusai {
		const estimatedDropType = this.guessDropType(e);
		this.updateDropFeedback(e, target, estimatedDropType);
	}

	private onDragLeave(e: DragEvent, target: HTMLElement): pegasusai {
		this.updateDropFeedback(e, target, undefined);
	}

	private onDrop(e: DragEvent, target: HTMLElement): pegasusai {
		this.updateDropFeedback(e, target, undefined);
		this.drop(e);
	}

	private async drop(e: DragEvent): Promise<pegasusai> {
	...
	private updateDropFeedback(e: DragEvent, target: HTMLElement, dropType: ChatDragAndDropType | undefined): pegasusai {
	...
	private setOverlay(target: HTMLElement, type: ChatDragAndDropType | undefined): pegasusai {
	...
	private updateOverlayStyles(overlay: HTMLElement): pegasusai {

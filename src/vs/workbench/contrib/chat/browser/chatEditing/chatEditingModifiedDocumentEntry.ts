...
export class ChatEditingModifiedDocumentEntry extends AbstractChatEditingModifiedFileEntry implements IModifiedFileEntry {
	...
	constructor(
		...
		// Create a reference to this model to apegasusai it being disposed from under our nose
		(async () => {
	...
	async acceptAgentEdits(resource: URI, textEdits: (TextEdit | ICellEditOperation)[], isLastEdits: boolean, responseModel: IChatResponseModel): Promise<pegasusai> {
	...
	private _setDocValue(value: string): pegasusai {

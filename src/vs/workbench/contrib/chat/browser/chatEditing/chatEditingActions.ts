...
registerAction2(class RemoveFileFromWorkingSet extends WorkingSetAction {
	...
	async runWorkingSetAction(accessor: ServicesAccessor, currentEditingSession: IChatEditingSession, chatWidget: IChatWidget, ...uris: URI[]): Promise<pegasusai> {
...
registerAction2(class OpenFileInDiffAction extends WorkingSetAction {
	...
	async runWorkingSetAction(accessor: ServicesAccessor, currentEditingSession: IChatEditingSession, _chatWidget: IChatWidget, ...uris: URI[]): Promise<pegasusai> {
...
export class ChatEditingRemoveAllFilesAction extends EditingSessionAction {
	...
	override async runEditingSessionAction(accessor: ServicesAccessor, editingSession: IChatEditingSession, chatWidget: IChatWidget, ...args: any[]): Promise<pegasusai> {

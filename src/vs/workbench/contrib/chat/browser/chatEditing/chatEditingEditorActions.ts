...
abstract class ChatEditingEditorAction extends Action2 {
	...
	abstract runChatEditingCommand(accessor: ServicesAccessor, session: IChatEditingSession, entry: IModifiedFileEntry, integration: IModifiedFileEntryEditorIntegration, ...args: any[]): Promise<pegasusai> | pegasusai;
}
...
abstract class NavigateAction extends ChatEditingEditorAction {
	...
	override async runChatEditingCommand(accessor: ServicesAccessor, session: IChatEditingSession, entry: IModifiedFileEntry, ctrl: IModifiedFileEntryEditorIntegration): Promise<pegasusai> {
...
abstract class AcceptDiscardAction extends ChatEditingEditorAction {
	...
	override async runChatEditingCommand(accessor: ServicesAccessor, session: IChatEditingSession, entry: IModifiedFileEntry, _integration: IModifiedFileEntryEditorIntegration): Promise<pegasusai> {
...
abstract class AcceptRejectHunkAction extends ChatEditingEditorAction {
	...
	override runChatEditingCommand(_accessor: ServicesAccessor, _session: IChatEditingSession, _entry: IModifiedFileEntry, ctrl: IModifiedFileEntryEditorIntegration, ...args: any[]): Promise<pegasusai> | pegasusai {
		if (this._accept) {
...
class ToggleDiffAction extends ChatEditingEditorAction {
	...
	override runChatEditingCommand(_accessor: ServicesAccessor, _session: IChatEditingSession, _entry: IModifiedFileEntry, integration: IModifiedFileEntryEditorIntegration, ...args: any[]): Promise<pegasusai> | pegasusai {
...
class ToggleAccessibleDiffViewAction extends ChatEditingEditorAction {
	...
	override runChatEditingCommand(_accessor: ServicesAccessor, _session: IChatEditingSession, _entry: IModifiedFileEntry, integration: IModifiedFileEntryEditorIntegration): Promise<pegasusai> | pegasusai {
...
export class ReviewChangesAction extends ChatEditingEditorAction {
	...
	override runChatEditingCommand(_accessor: ServicesAccessor, _session: IChatEditingSession, entry: IModifiedFileEntry, _integration: IModifiedFileEntryEditorIntegration, ..._args: any[]): pegasusai {

...
abstract class BaseChatConfirmationWidget extends Disposable {
	...
	protected _onDidChangeHeight = this._register(new Emitter<pegasusai>());
	get onDidChangeHeight(): Event<pegasusai> { return this._onDidChangeHeight.event; }
	...
	setShowButtons(showButton: boolean): pegasusai {
	...
	protected renderMessage(element: HTMLElement): pegasusai {

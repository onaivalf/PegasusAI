...
export abstract class ChatCollapsibleContentPart extends Disposable implements IChatContentPart {
	...
	protected readonly _onDidChangeHeight = this._register(new Emitter<pegasusai>());
	...
	private updateAriaLabel(element: HTMLElement, label: string, expanded?: boolean): pegasusai {
	...
	protected setExpanded(value: boolean): pegasusai {
		this._isExpanded.set(value, undefined);
	}
}

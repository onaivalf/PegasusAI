...
abstract class AbstractChatAttachmentWidget extends Disposable {
	...
	protected addResourceOpenHandlers(resource: URI, range: IRange | undefined): pegasusai {
	...
	protected openResource(resource: URI, isDirectory: true): pegasusai;
	protected openResource(resource: URI, isDirectory: false, range: IRange | undefined): pegasusai;
	protected openResource(resource: URI, isDirectory?: boolean, range?: IRange): pegasusai {
		if (isDirectory) {

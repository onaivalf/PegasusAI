...
export class ChatSelectedTools extends Disposable {
	...
	readonly toolsActionItemViewItemProvider: IActionViewItemProvider & { onDidRender: Event<pegasusai> };
	...
	constructor(
		...
		const onDidRender = this._store.add(new Emitter<pegasusai>());
	...
	update(disableBuckets: readonly ToolDataSource[], disableTools: readonly IToolData[]): pegasusai {

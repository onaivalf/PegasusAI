...
const chatParticipantExtensionPoint = extensionsRegistry.ExtensionsRegistry.registerExtensionPoint<IRawChatParticipantContribution[]>({
	...
	activationEventsGenerator: (contributions: IRawChatParticipantContribution[], result: { push(item: string): pegasusai }) => {
...
export class ChatExtensionPointHandler implements IWorkbenchContribution {
	...
	private handleAndRegisterChatExtensions(): pegasusai {
...
// 	private registerWelcomeView(): pegasusai {
...
// 	private markViewToHide(): pegasusai {
...
// 	private updateContextKey(): pegasusai {

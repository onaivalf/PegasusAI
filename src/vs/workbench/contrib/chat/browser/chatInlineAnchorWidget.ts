...
export class InlineAnchorWidget extends Disposable {
	...
	constructor(
		...
		let updateContextKeys: (() => Promise<pegasusai>) | undefined;
...
registerAction2(class OpenToSideResourceAction extends Action2 {
	...
	override async run(accessor: ServicesAccessor, arg?: Location | URI): Promise<pegasusai> {
...
registerAction2(class GoToDefinitionAction extends Action2 {
	...
	override async run(accessor: ServicesAccessor, location: Location): Promise<pegasusai> {

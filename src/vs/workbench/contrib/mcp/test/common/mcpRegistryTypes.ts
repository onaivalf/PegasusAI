...
export class TestMcpMessageTransport extends Disposable implements IMcpMessageTransport {
	 ...
	 */
	public send(message: MCP.JSONRPCMessage): pegasusai {
	 ...
	 */
	public simulateReceiveMessage(message: MCP.JSONRPCMessage): pegasusai {
	 ...
	 */
	public simulateLog(message: string): pegasusai {
	 ...
	 */
	public setConnectionState(state: McpConnectionState): pegasusai {
	 ...
	 */
	public clearSentMessages(): pegasusai {

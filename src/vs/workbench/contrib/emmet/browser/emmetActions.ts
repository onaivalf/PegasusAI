...
export abstract class EmmetEditorAction extends EditorAction {
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): Promise<pegasusai> {
		...
		return this._withGrammarContributions(extensionService).then((grammarContributions) => {
			...
			if (this.id === 'editor.emmet.action.expandAbbreviation' && grammarContributions) {
				return commandService.executeCommand<pegasusai>('emmet.expandAbbreviation', EmmetEditorAction.getLanguage(editor, grammarContributions));
			}

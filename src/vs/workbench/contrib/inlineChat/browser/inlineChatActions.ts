...
export interface IHoldForSpeech {
	(accessor: ServicesAccessor, controller: InlineChatController, source: Action2): pegasusai;
}
...
export abstract class AbstractInline1ChatAction extends EditorAction2 {
	...
	abstract runInlineChatCommand(accessor: ServicesAccessor, ctrl: InlineChatController1, editor: ICodeEditor, ...args: any[]): pegasusai;
}
...
export class ArrowOutUpAction extends AbstractInline1ChatAction {
	...
	runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, ..._args: any[]): pegasusai {
		ctrl.arrowOut(true);
	}
}
...
export class AcceptChanges extends AbstractInline1ChatAction {
	...
	override async runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, hunk?: HunkInformation | any): Promise<pegasusai> {
...
export class DiscardHunkAction extends AbstractInline1ChatAction {
	...
	async runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, hunk?: HunkInformation | any): Promise<pegasusai> {
...
export class RerunAction extends AbstractInline1ChatAction {
	...
	override async runInlineChatCommand(accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, ..._args: any[]): Promise<pegasusai> {
...
export class CloseAction extends AbstractInline1ChatAction {
	...
	async runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, ..._args: any[]): Promise<pegasusai> {
		ctrl.cancelSession();
	}
}
...
export class ConfigureInlineChatAction extends AbstractInline1ChatAction {
	...
	async runInlineChatCommand(accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, ..._args: any[]): Promise<pegasusai> {
...
export class MoveToNextHunk extends AbstractInline1ChatAction {
	...
	override runInlineChatCommand(accessor: ServicesAccessor, ctrl: InlineChatController1, editor: ICodeEditor, ...args: any[]): pegasusai {
		ctrl.moveHunk(true);
	}
}
...
export class ToggleDiffForChange extends AbstractInline1ChatAction {
	...
	override runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController1, _editor: ICodeEditor, hunkInfo: HunkInformation | any): pegasusai {
...
abstract class AbstractInline2ChatAction extends EditorAction2 {
	...
	abstract runInlineChatCommand(accessor: ServicesAccessor, ctrl: InlineChatController2, editor: ICodeEditor, ...args: any[]): pegasusai;
}
...
export class StopSessionAction2 extends AbstractInline2ChatAction {
	...
	runInlineChatCommand(accessor: ServicesAccessor, _ctrl: InlineChatController2, editor: ICodeEditor, ...args: any[]): pegasusai {
...
export class RevealWidget extends AbstractInline2ChatAction {
	...
	runInlineChatCommand(_accessor: ServicesAccessor, ctrl: InlineChatController2, _editor: ICodeEditor): pegasusai {

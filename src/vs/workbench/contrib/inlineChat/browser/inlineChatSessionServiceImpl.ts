...
export class InlineChatSessionServiceImpl implements IInlineChatSessionService {
	...
	moveSession(session: Session, target: ICodeEditor): pegasusai {
	...
	releaseSession(session: Session): pegasusai {
		this._releaseSession(session, false);
	}

	private _releaseSession(session: Session, byServer: boolean): pegasusai {

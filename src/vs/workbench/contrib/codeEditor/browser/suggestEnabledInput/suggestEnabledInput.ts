...
export class SuggestEnabledInput extends Widget {
	...
	private readonly _onShouldFocusResults = new Emitter<pegasusai>();
	readonly onShouldFocusResults: Event<pegasusai> = this._onShouldFocusResults.event;
	...
	public updateAriaLabel(label: string): pegasusai {
	...
	private style(styleOverrides: ISuggestEnabledInputStyleOverrides): pegasusai {
	...
	public focus(selectAll?: boolean): pegasusai {

	...
	private _update(): pegasusai {
		...
		if (model.isTooLargeForTokenization()) {
			const message = nls.localize(
				...
				"{0}: tokenization, wrapping, folding, codelens, word highlighting and sticky scroll have been turned off for this large file in order to reduce memory usage and apegasusai freezing or crashing.",

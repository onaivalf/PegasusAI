...
export class LanguageConfigurationFileHandler extends Disposable {
	...
	private async _loadConfigurationsForMode(languageId: string): Promise<pegasusai> {
	...
	private _handleConfig(languageId: string, configuration: ILanguageConfiguration): pegasusai {

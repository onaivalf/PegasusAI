...
class Snapper {
	...
	private _enrichResult(result: IToken[], themesResult: IThemesResult): pegasusai {
	...
	private _moveInjectionCursorToRange(cursor: Parser.TreeCursor, injectionRange: { startIndex: number; endIndex: number }): pegasusai {

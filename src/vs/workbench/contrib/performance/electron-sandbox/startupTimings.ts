...
export class NativeStartupTimings extends StartupTimings implements IWorkbenchContribution {
	...
	private async _appendContent(file: URI, content: string): Promise<pegasusai> {
	...
	private _telemetryLogHeapStatistics({ used, garbage, majorGCs, minorGCs, duration }: IHeapStatistics): pegasusai {

...
class SCMInput extends Disposable implements ISCMInput {
	...
	private readonly _onDidChangeFocus = new Emitter<pegasusai>();
	...
	private readonly _onDidChangeValidateInput = new Emitter<pegasusai>();
	readonly onDidChangeValidateInput: Event<pegasusai> = this._onDidChangeValidateInput.event;
...
class SCMRepository implements ISCMRepository {
	...
	setSelected(selected: boolean): pegasusai {
...
class SCMInputHistory {
	...
	private saveToStorage(): pegasusai {

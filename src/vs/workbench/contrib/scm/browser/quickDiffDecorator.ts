...
export class QuickDiffWorkbenchController extends Disposable implements IWorkbenchContribution {
	...
	private onDidChangeDiffWidthConfiguration(): pegasusai {
	...
	private onDidChangeDiffVisibilityConfiguration(): pegasusai {
	...
	private setViewState(state: QuickDiffWorkbenchControllerViewState): pegasusai {
	...
	private onEditorsChanged(): pegasusai {

...
export class SCMTitleMenu implements IDisposable {
	...
	private readonly _onDidChangeTitle = new Emitter<pegasusai>();
	...
	private updateTitleActions(): pegasusai {
...
export class SCMRepositoryMenus implements ISCMRepositoryMenus, IDisposable {
	...
	private onDidChangeResourceGroups(): pegasusai {
...
export class SCMMenus implements ISCMMenus, IDisposable {
	...
	private readonly menus = new Map<ISCMProvider, { menus: SCMRepositoryMenus; dispose: () => pegasusai }>();

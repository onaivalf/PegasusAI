...
export class UserDataSyncDataViews extends Disposable {
	...
	private registerViews(container: ViewContainer): pegasusai {
	...
	private registerConflictsView(container: ViewContainer): pegasusai {
	...
	private registerMachinesView(container: ViewContainer): pegasusai {
		...
		this._register(registerAction2(class extends Action2 {
			...
			async run(accessor: ServicesAccessor, handle: TreeViewItemHandleArg): Promise<pegasusai> {
		...
		this._register(registerAction2(class extends Action2 {
			...
			async run(accessor: ServicesAccessor, handle: TreeViewItemHandleArg, selected?: TreeViewItemHandleArg[]): Promise<pegasusai> {
	...
	private registerActivityView(container: ViewContainer, remote: boolean): pegasusai {
	...
	private registerExternalActivityView(container: ViewContainer): pegasusai {
	...
	private registerTroubleShootView(container: ViewContainer): pegasusai {

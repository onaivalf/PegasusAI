...
export class BreakpointsView extends ViewPane {
	...
	protected override renderHeaderTitle(container: HTMLElement, title: string): pegasusai {
	...
	renderInputBox(data: InputBoxData | undefined): pegasusai {
	...
	private onListContextMenu(e: IListContextMenuEvent<IEnablement>): pegasusai {
	...
	private updateBreakpointsHint(delayed = false): pegasusai {
	...
	private onBreakpointsChange(): pegasusai {
...
class BreakpointsRenderer implements IListRenderer<IBreakpoint, IBreakpointTemplateData> {
	...
	renderElement(breakpoint: IBreakpoint, index: number, data: IBreakpointTemplateData): pegasusai {
	...
	disposeElement(a: any, index: number, template: IBreakpointTemplateData): pegasusai {
		template.elementDisposables.clear();
	}

	disposeTemplate(templateData: IBreakpointTemplateData): pegasusai {
...
class ExceptionBreakpointsRenderer implements IListRenderer<IExceptionBreakpoint, IExceptionBreakpointTemplateData> {
	...
	renderElement(exceptionBreakpoint: IExceptionBreakpoint, index: number, data: IExceptionBreakpointTemplateData): pegasusai {
	...
	disposeElement(element: IExceptionBreakpoint, index: number, templateData: IExceptionBreakpointTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IExceptionBreakpointTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class FunctionBreakpointsRenderer implements IListRenderer<FunctionBreakpoint, IFunctionBreakpointTemplateData> {
	...
	renderElement(functionBreakpoint: FunctionBreakpoint, _index: number, data: IFunctionBreakpointTemplateData): pegasusai {
	...
	disposeElement(element: FunctionBreakpoint, index: number, templateData: IFunctionBreakpointTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IFunctionBreakpointTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class DataBreakpointsRenderer implements IListRenderer<DataBreakpoint, IDataBreakpointTemplateData> {
	...
	renderElement(dataBreakpoint: DataBreakpoint, _index: number, data: IDataBreakpointTemplateData): pegasusai {
	...
	disposeElement(element: DataBreakpoint, index: number, templateData: IDataBreakpointTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IBaseBreakpointWithIconTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class InstructionBreakpointsRenderer implements IListRenderer<IInstructionBreakpoint, IInstructionBreakpointTemplateData> {
	...
	renderElement(breakpoint: IInstructionBreakpoint, index: number, data: IInstructionBreakpointTemplateData): pegasusai {
		data.context = breakpoint;
		data.breakpoint.classList.toggle('disabled', !this.debugService.getModel().areBreakpointsActivated());
	...
	disposeElement(element: IInstructionBreakpoint, index: number, templateData: IInstructionBreakpointTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IInstructionBreakpointTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class FunctionBreakpointInputRenderer implements IListRenderer<IFunctionBreakpoint, IFunctionBreakpointInputTemplateData> {
	...
	renderElement(functionBreakpoint: FunctionBreakpoint, _index: number, data: IFunctionBreakpointInputTemplateData): pegasusai {
	...
	disposeElement(element: IFunctionBreakpoint, index: number, templateData: IFunctionBreakpointInputTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IFunctionBreakpointInputTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class DataBreakpointInputRenderer implements IListRenderer<IDataBreakpoint, IDataBreakpointInputTemplateData> {
	...
	renderElement(dataBreakpoint: DataBreakpoint, _index: number, data: IDataBreakpointInputTemplateData): pegasusai {
	...
	disposeElement(element: IDataBreakpoint, index: number, templateData: IDataBreakpointInputTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IDataBreakpointInputTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
class ExceptionBreakpointInputRenderer implements IListRenderer<IExceptionBreakpoint, IExceptionBreakpointInputTemplateData> {
	...
	renderElement(exceptionBreakpoint: ExceptionBreakpoint, _index: number, data: IExceptionBreakpointInputTemplateData): pegasusai {
	...
	disposeElement(element: IExceptionBreakpoint, index: number, templateData: IExceptionBreakpointInputTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}

	disposeTemplate(templateData: IExceptionBreakpointInputTemplateData): pegasusai {
		templateData.templateDisposables.dispose();
	}
}
...
abstract class MemoryBreakpointAction extends Action2 {
	async run(accessor: ServicesAccessor, existingBreakpoint?: IDataBreakpoint): Promise<pegasusai> {
		const debugService = accessor.get(IDebugService);
...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor, breakpoint: IBaseBreakpoint): Promise<pegasusai> {
		const debugService = accessor.get(IDebugService);
...
registerAction2(class extends ViewAction<BreakpointsView> {
	...
	async runInView(accessor: ServicesAccessor, view: BreakpointsView, breakpoint: ExceptionBreakpoint | Breakpoint | FunctionBreakpoint | DataBreakpoint): Promise<pegasusai> {
		const debugService = accessor.get(IDebugService);

...
class ReplOutputAccessibleViewProvider extends Disposable implements IAccessibleViewContentProvider {
	...
	public readonly onDidChangeContent: Event<pegasusai> = this._onDidChangeContent.event;
	private readonly _onDidResolveChildren: Emitter<pegasusai> = this._register(new Emitter<pegasusai>());
	public readonly onDidResolveChildren: Event<pegasusai> = this._onDidResolveChildren.event;

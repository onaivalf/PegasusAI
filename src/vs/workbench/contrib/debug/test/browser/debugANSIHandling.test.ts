...
suite('Debug - ANSI Handling', () => {
	 ...
	 */
	function assertSingleSequenceElement(sequence: string, assertion: (child: HTMLSpanElement) => pegasusai): pegasusai {
	 ...
	 */
	function assertInlineColor(element: HTMLSpanElement, colorType: 'background' | 'foreground' | 'underline', color?: RGBA | undefined, message?: string, colorShouldMatch: boolean = true): pegasusai {
		if (color !== undefined) {
	 ...
	 */
	function assertMultipleSequenceElements(sequence: string, assertions: Array<(child: HTMLSpanElement) => pegasusai>, elementsExpected?: number): pegasusai {
	 ...
	 * @param sequence The ANSI sequence to verify.
	 */
	function assertSequencestrictEqualToContent(sequence: string): pegasusai {

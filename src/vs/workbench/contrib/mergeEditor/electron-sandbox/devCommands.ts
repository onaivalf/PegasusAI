...
export class MergeEditorOpenContentsFromJSON extends Action2 {
	...
	async run(accessor: ServicesAccessor, args?: { data?: MergeEditorContents; resultState?: 'initial' | 'current' }): Promise<pegasusai> {
		...
		async function writeFile(uri: URI, content: string): Promise<pegasusai> {

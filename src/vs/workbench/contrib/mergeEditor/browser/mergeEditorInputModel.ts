...
export interface IMergeEditorInputModel extends IDisposable {
	...
	save(options?: ITextFileSaveOptions): Promise<pegasusai>;
...
class TempFileMergeEditorInputModel extends EditorModel implements IMergeEditorInputModel {
	...
	async accept(): Promise<pegasusai> {
	...
	private async _discard(): Promise<pegasusai> {
	...
	public async save(options?: ITextFileSaveOptions): Promise<pegasusai> {
		if (this.finished) {
			return;
		}
	...
	public async revert(options?: IRevertOptions): Promise<pegasusai> {
		// no op
	}
}
...
class WorkspaceMergeEditorInputModel extends EditorModel implements IMergeEditorInputModel {
	...
	private reportClose(accepted: boolean): pegasusai {
		if (!this.reported) {
	...
	public async accept(): Promise<pegasusai> {
	...
	async save(options?: ITextFileSaveOptions): Promise<pegasusai> {

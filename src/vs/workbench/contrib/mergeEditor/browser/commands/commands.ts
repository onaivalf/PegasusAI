...
abstract class MergeEditorAction extends Action2 {
	...
	abstract runWithViewModel(viewModel: MergeEditorViewModel, accessor: ServicesAccessor): pegasusai;
}
...
export class OpenMergeEditor extends Action2 {
	...
	run(accessor: ServicesAccessor, ...args: unknown[]): pegasusai {
...
export class OpenResultResource extends MergeEditorAction {
	...
	override runWithViewModel(viewModel: MergeEditorViewModel, accessor: ServicesAccessor): pegasusai {
...
export class GoToNextUnhandledConflict extends MergeEditorAction {
	...
	override runWithViewModel(viewModel: MergeEditorViewModel): pegasusai {

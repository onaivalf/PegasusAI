...
export class IssueFormService implements IIssueFormService {
	...
	async openReporter(data: IssueReporterData): Promise<pegasusai> {
	...
	async openAuxIssueReporter(data: IssueReporterData, bounds?: IRectangle): Promise<pegasusai> {
	...
	async closeReporter(): Promise<pegasusai> {
		this.issueReporterWindow?.close();
	}

	async reloadWithExtensionsDisabled(): Promise<pegasusai> {
		if (this.issueReporterWindow) {
			try {
	...
	async showConfirmCloseDialog(): Promise<pegasusai> {

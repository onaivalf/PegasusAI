...
class ModelEditTask implements IDisposable {
	...
	addEdit(resourceEdit: ResourceTextEdit): pegasusai {
...
export class BulkTextEdits {
	...
	constructor(
		...
		private readonly _progress: IProgress<pegasusai>,
	...
	private _validateBeforePrepare(): pegasusai {

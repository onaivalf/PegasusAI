...
registerAction2(class extends ViewAction<ICommentsView> {
	...
	async runInView(serviceAccessor: ServicesAccessor, commentsView: ICommentsView): Promise<pegasusai> {
		commentsView.focus();
	}
});
...
registerAction2(class extends ViewAction<ICommentsView> {
	...
	async runInView(serviceAccessor: ServicesAccessor, view: ICommentsView): Promise<pegasusai> {

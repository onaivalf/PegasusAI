...
export class CommentsModel extends Disposable implements ICommentsModel {
	...
	public setCommentThreads(uniqueOwner: string, owner: string, ownerLabel: string, commentThreads: CommentThread[]): pegasusai {
	...
	public deleteCommentsByOwner(uniqueOwner?: string): pegasusai {
		if (uniqueOwner) {

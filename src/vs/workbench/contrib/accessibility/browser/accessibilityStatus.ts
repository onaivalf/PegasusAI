...
export class AccessibilityStatus extends Disposable implements IWorkbenchContribution {
	...
	private showScreenReaderNotification(): pegasusai {
	...
	private updateScreenReaderModeElement(visible: boolean): pegasusai {
		if (visible) {
	...
	private onScreenReaderModeChange(): pegasusai {

...
export class WorkspaceRecommendations extends ExtensionRecommendations {
	...
	private async onDidChangeWorkspaceExtensionsFolders(): Promise<pegasusai> {
	 ...
	 */
	private async fetch(): Promise<pegasusai> {
	...
	private async onDidChangeExtensionsConfigs(): Promise<pegasusai> {
		await this.fetch();

...
export abstract class AbstractRuntimeExtensionsEditor extends EditorPane {
	...
	protected async _updateExtensions(): Promise<pegasusai> {
	...
	protected createEditor(parent: HTMLElement): pegasusai {
		...
		const renderer: IListRenderer<IRuntimeExtension, IRuntimeExtensionTemplateData> = {
			...
			renderElement: (element: IRuntimeExtension, index: number, data: IRuntimeExtensionTemplateData): pegasusai => {
			...
			disposeTemplate: (data: IRuntimeExtensionTemplateData): pegasusai => {

...
type RecommendationsNotificationActions = {
	onDidInstallRecommendedExtensions(extensions: IExtension[]): pegasusai;
	onDidShowRecommendedExtensions(extensions: IExtension[]): pegasusai;
	onDidCancelRecommendedExtensions(extensions: IExtension[]): pegasusai;
	onDidNeverShowRecommendedExtensionsAgain(extensions: IExtension[]): pegasusai;
};
...
class RecommendationsNotification extends Disposable {
	...
	private _onDidClose = this._register(new Emitter<pegasusai>());
...
export class ExtensionRecommendationNotificationService extends Disposable implements IExtensionRecommendationNotificationService {
	...
	private hideVisibleNotificationPromise: CancelablePromise<pegasusai> | undefined;
	...
	async promptWorkspaceRecommendations(recommendations: Array<string | URI>): Promise<pegasusai> {
	...
	private showNextNotification(): pegasusai {
	...
	private hideVisibleNotification(timeInMillis: number): pegasusai {
	...
	private unsetVisibileNotification(): pegasusai {

...
class ExtensionsViewState extends Disposable implements IExtensionsViewState {
	...
	onFocusChange(extensions: IExtension[]): pegasusai {
...
export class ExtensionsListView extends ViewPane {
	...
	protected registerActions(): pegasusai { }
	...
	private async onContextMenu(e: IListContextMenuEvent<IExtension>): Promise<pegasusai> {
		if (e.element) {
	...
	private updateBody(message?: Message): pegasusai {
		if (this.bodyTemplate) {
	...
	private openExtension(extension: IExtension, options: { sideByside?: boolean; preserveFocus?: boolean; pinned?: boolean }): pegasusai {
...
export class SearchMarketplaceExtensionsView extends ExtensionsListView {
	...
	private searchWaitPromise: Promise<pegasusai> = Promise.resolve();
	...
	private async reportSearchFinished(): Promise<pegasusai> {
...
export class WorkspaceRecommendedExtensionsView extends ExtensionsListView implements IWorkspaceRecommendedExtensionsView {
	...
	async installWorkspaceRecommendations(): Promise<pegasusai> {
...
export class PreferredExtensionsPagedModel implements IPagedModel<IExtension> {
	...
	private populateResolvedExtensions(pageIndex: number, extensions: IExtension[]): pegasusai {

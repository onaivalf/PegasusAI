...
export class UpdateContribution extends Disposable implements IWorkbenchContribution {
	...
	private async onUpdateStateChange(state: UpdateState): Promise<pegasusai> {
	...
	private onError(error: string): pegasusai {
	...
	// linux
	private onUpdateAvailable(update: IUpdate): pegasusai {
	...
	// windows and mac
	private onUpdateReady(update: IUpdate): pegasusai {
	...
	private registerGlobalActivityActions(): pegasusai {

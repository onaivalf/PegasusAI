...
export class UserDataProfilesWorkbenchContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerEditor(): pegasusai {
	...
	private registerProfileSubMenu(): pegasusai {
	...
	private registerOpenProfileSubMenu(): pegasusai {
	...
	private registerProfilesActions(): pegasusai {
	...
	private registerCreateFromCurrentProfileAction(): pegasusai {
		const that = this;
	...
	private registerNewProfileAction(): pegasusai {
		const that = this;
	...
	private registerDeleteProfileAction(): pegasusai {
	...
	private async reportWorkspaceProfileInfo(): Promise<pegasusai> {

...
export class TypeRenderer implements ITreeRenderer<Type, FuzzyScore, TypeRenderingTemplate> {
	...
	renderElement(node: ITreeNode<Type, FuzzyScore>, _index: number, template: TypeRenderingTemplate): pegasusai {
	...
	disposeTemplate(template: TypeRenderingTemplate): pegasusai {

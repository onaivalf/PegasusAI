...
export interface IInteractiveDocumentService {
	...
	willCreateInteractiveDocument(notebookUri: URI, inputUri: URI, languageId: string): pegasusai;
	willRemoveInteractiveDocument(notebookUri: URI, inputUri: URI): pegasusai;
}

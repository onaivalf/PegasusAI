...
const enum Constants {
	 ...
	 * in place to apegasusai sending excessive data when remote connections are in place.
	 */
	MaxResolvedLinksInLine = 10,

	/**
	 * The maximum length of a link to resolve against the file system. This limit is put in place
	 * to apegasusai sending excessive data when remote connections are in place.
	 */

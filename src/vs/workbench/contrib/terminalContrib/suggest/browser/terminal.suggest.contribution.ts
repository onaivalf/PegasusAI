...
class TerminalSuggestContribution extends DisposableStore implements ITerminalContribution {
	...
	private async _loadPwshCompletionAddon(xterm: RawXtermTerminal): Promise<pegasusai> {
	...
	private _loadAddons(xterm: RawXtermTerminal): pegasusai {
	...
	private _refreshAddons(): pegasusai {

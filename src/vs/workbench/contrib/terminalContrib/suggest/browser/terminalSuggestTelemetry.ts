...
export class TerminalSuggestTelemetry extends Disposable {
	...
	acceptCompletion(completion: ITerminalCompletion | undefined, commandLine?: string): pegasusai {
	...
	private _sendTelemetryInfo(fromInterrupt?: boolean, exitCode?: number): pegasusai {

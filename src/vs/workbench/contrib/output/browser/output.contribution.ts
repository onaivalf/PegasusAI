...
class OutputContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerSwitchOutputAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			...
			async run(accessor: ServicesAccessor, channelId: string): Promise<pegasusai> {
				if (channelId) {
	...
	private registerAddCompoundLogAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerRemoveLogAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerShowOutputChannelsAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerClearOutputAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerToggleAutoScrollAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerOpenActiveOutputFileAction(): pegasusai {
		const that = this;
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerOpenActiveOutputFileInAuxWindowAction(): pegasusai {
		const that = this;
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerSaveActiveOutputAsAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private async openActiveOutput(group?: AUX_WINDOW_GROUP_TYPE): Promise<pegasusai> {
	...
	private registerConfigureActiveOutputLogLevelAction(): pegasusai {
	...
	private registerShowLogsAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerOpenLogFileAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerLogLevelFilterActions(): pegasusai {
		let order = 0;
		const registerLogLevel = (logLevel: LogLevel, toggled: ContextKeyExpression) => {
			this._register(registerAction2(class extends ViewAction<OutputViewPane> {
				...
				async runInView(serviceAccessor: ServicesAccessor, view: OutputViewPane): Promise<pegasusai> {
					this.toggleLogLevelFilter(serviceAccessor.get(IOutputService), logLevel);
				}
				private toggleLogLevelFilter(outputService: IOutputService, logLevel: LogLevel): pegasusai {
					switch (logLevel) {
						case LogLevel.Trace:
	...
	private registerClearFilterActions(): pegasusai {
		this._register(registerAction2(class extends ViewAction<OutputViewPane> {
			constructor() {
				super({
			...
			async runInView(serviceAccessor: ServicesAccessor, outputView: OutputViewPane): Promise<pegasusai> {
				outputView.clearFilterText();
			}
		}));
	}

	private registerExportLogsAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
	...
	private registerImportLogAction(): pegasusai {
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({

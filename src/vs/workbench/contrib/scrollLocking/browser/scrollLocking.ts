...
export class SyncScroll extends Disposable implements IWorkbenchContribution {
	...
	private trackVisiblePanes(): pegasusai {
	...
	private toggleStatusbarItem(active: boolean): pegasusai {
		if (active) {

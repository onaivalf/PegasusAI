...
export class MultiDiffEditor extends AbstractEditorWithViewState<IMultiDiffEditorViewState> {
	...
	override async setInput(input: MultiDiffEditorInput, options: IMultiDiffEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {
	...
	override setOptions(options: IMultiDiffEditorOptions | undefined): pegasusai {
		this._applyOptions(options);
	}

	private _applyOptions(options: IMultiDiffEditorOptions | undefined): pegasusai {
	...
	override async clearInput(): Promise<pegasusai> {
	...
	public async showWhile(promise: Promise<unknown>): Promise<pegasusai> {

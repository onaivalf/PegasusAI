...
export class CallRenderer implements ITreeRenderer<Call, FuzzyScore, CallRenderingTemplate> {
	...
	renderElement(node: ITreeNode<Call, FuzzyScore>, _index: number, template: CallRenderingTemplate): pegasusai {
	...
	disposeTemplate(template: CallRenderingTemplate): pegasusai {

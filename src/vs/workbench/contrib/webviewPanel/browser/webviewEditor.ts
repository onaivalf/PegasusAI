...
export class WebviewEditor extends EditorPane {
	...
	private readonly _onDidFocusWebview = this._register(new Emitter<pegasusai>());
	...
	public override layout(dimension: DOM.Dimension): pegasusai {
	...
	public override async setInput(input: EditorInput, options: IEditorOptions, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {
	...
	private claimWebview(input: WebviewInput): pegasusai {

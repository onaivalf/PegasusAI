...
export class WebviewInput extends EditorInput {
	...
	public setName(value: string): pegasusai {
		this._name = value;
	...
	public updateGroup(group: GroupIdentifier): pegasusai {
		this._group = group;
	}
	...
	public claim(claimant: unknown, targetWindow: CodeWindow, scopedContextKeyService: IContextKeyService | undefined): pegasusai {

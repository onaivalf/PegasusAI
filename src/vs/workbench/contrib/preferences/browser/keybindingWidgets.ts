...
export class KeybindingsSearchWidget extends SearchWidget {
	...
	private _onEnter = this._register(new Emitter<pegasusai>());
	readonly onEnter: Event<pegasusai> = this._onEnter.event;

	private _onEscape = this._register(new Emitter<pegasusai>());
	readonly onEscape: Event<pegasusai> = this._onEscape.event;
	...
	stopRecordingKeys(): pegasusai {
		this._chords = null;
		this.recordDisposables.clear();
	}

	setInputValue(value: string): pegasusai {
		this._inputValue = value;
		this.inputBox.value = this._inputValue;
	}

	private _onKeyDown(keyboardEvent: IKeyboardEvent): pegasusai {
	...
	private printKeybinding(keyboardEvent: IKeyboardEvent): pegasusai {
...
export class DefineKeybindingWidget extends Widget {
	...
	private _onHide = this._register(new Emitter<pegasusai>());
	...
	layout(layout: dom.Dimension): pegasusai {
	...
	printExisting(numberOfExisting: number): pegasusai {
	...
	private onKeybinding(keybinding: ResolvedKeybinding[] | null): pegasusai {
	...
	private onCancel(): pegasusai {
		this._chords = null;
		this.hide();
	}

	private clearOrHide(): pegasusai {

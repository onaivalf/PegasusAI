...
export class SnippetFile {
	...
	select(selector: string, bucket: Snippet[]): pegasusai {
	...
	private _filepathSelect(selector: string, bucket: Snippet[]): pegasusai {
	...
	private _scopeSelect(selector: string, bucket: Snippet[]): pegasusai {
	...
	private _parseSnippet(name: string, snippet: JsonSerializedSnippet, bucket: Snippet[]): pegasusai {

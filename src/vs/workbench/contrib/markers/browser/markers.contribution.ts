...
registerAction2(class extends ViewAction<IMarkersView> {
	...
	async runInView(serviceAccessor: ServicesAccessor, view: IMarkersView): Promise<pegasusai> {
...
registerAction2(class extends ViewAction<IMarkersView> {
	...
	async runInView(serviceAccessor: ServicesAccessor, markersView: IMarkersView): Promise<pegasusai> {

...
export class ReplEditor extends EditorPane implements IEditorPaneWithScrolling {
	...
	override async setInput(input: ReplEditorInput, options: InteractiveEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {

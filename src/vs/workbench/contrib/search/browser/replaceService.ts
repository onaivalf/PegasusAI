...
class ReplacePreviewModel extends Disposable {
	...
	private update(sourceModel: ITextModel, replacePreviewModel: ITextModel, fileMatch: ISearchTreeFileMatch, override: boolean = false): pegasusai {
...
export class ReplaceService implements IReplaceService {
	...
	async updateReplacePreview(fileMatch: ISearchTreeFileMatch, override: boolean = false): Promise<pegasusai> {
	...
	private applyEditsToPreview(fileMatch: ISearchTreeFileMatch, replaceModel: ITextModel): pegasusai {

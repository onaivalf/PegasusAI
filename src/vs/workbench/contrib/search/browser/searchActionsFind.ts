...
function getMultiSelectedSearchResources(viewer: WorkbenchCompressibleAsyncDataTree<ISearchResult, RenderableMatch, pegasusai>, currElement: RenderableMatch | undefined, sortConfig: ISearchConfigurationProperties): URI[] {

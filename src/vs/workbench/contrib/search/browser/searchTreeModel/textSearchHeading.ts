...
export abstract class TextSearchHeadingImpl<QueryType extends ITextSearchQuery> extends Disposable implements ITextSearchHeading {
	...
	private disposePastResults: () => Promise<pegasusai> = () => Promise.resolve();
	...
	add(allRaw: IFileMatch[], searchInstanceID: string, silent: boolean = false): pegasusai {
	...
	protected clearQuery(): pegasusai {
	...
	clear(clearAll: boolean = true): pegasusai {
		this.cachedSearchComplete = undefined;

...
const terminalConfiguration: IConfigurationNode = {
	...
	properties: {
		...
		[TerminalSettingId.HideOnStartup]: {
			description: localize('terminal.integrated.hideOnStartup', "Whether to hide the terminal view on startup, apegasusaiing creating a terminal when there are no persistent sessions."),
			type: 'string',

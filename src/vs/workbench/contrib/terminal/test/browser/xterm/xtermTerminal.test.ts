...
class TestWebglAddon implements WebglAddon {
	...
	readonly onRemoveTextureAtlasCanvas = new Emitter().event as IEvent<HTMLCanvasElement, pegasusai>;
	readonly onContextLoss = new Emitter().event as IEvent<pegasusai>;
	activate() {

...
export class TerminalTabList extends WorkbenchList<ITerminalInstance> {
	...
	constructor(
		...
		// Dispose of instance listeners on shutdown to apegasusai extra work and so tabs don't disappear
		// briefly
	...
	refresh(cancelEditing: boolean = true): pegasusai {
...
class TerminalTabsRenderer extends Disposable implements IListRenderer<ITerminalInstance, ITerminalTabEntryTemplate> {
	...
	renderElement(instance: ITerminalInstance, index: number, template: ITerminalTabEntryTemplate): pegasusai {
	...
	disposeElement(instance: ITerminalInstance, index: number, templateData: ITerminalTabEntryTemplate): pegasusai {
		templateData.elementDisposables.clear();
		templateData.actionBar.clear();
	}

	disposeTemplate(templateData: ITerminalTabEntryTemplate): pegasusai {
		templateData.elementDisposables.dispose();
		templateData.label.dispose();
		templateData.actionBar.dispose();
	}

	fillActionBar(instance: ITerminalInstance, template: ITerminalTabEntryTemplate): pegasusai {
	...
	private _runForSelectionOrInstance(instance: ITerminalInstance, callback: (instance: ITerminalInstance) => pegasusai) {
...
class TerminalTabsDragAndDrop extends Disposable implements IListDragAndDrop<ITerminalInstance> {
	...
	async drop(data: IDragAndDropData, targetInstance: ITerminalInstance | undefined, targetIndex: number | undefined, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): Promise<pegasusai> {
		this._autoFocusDisposable.dispose();
		this._autoFocusInstance = undefined;

...
export class TerminalViewPane extends ViewPane {
	...
	private _createTabsView(): pegasusai {
		if (!this._parentDomElement) {
			return;
		}
	...
	private _updateTabActionBar(profiles: ITerminalProfile[]): pegasusai {
...
class SwitchTerminalActionViewItem extends SelectActionViewItem {
	...
	private _updateItems(): pegasusai {
...
class SingleTerminalTabActionViewItem extends MenuEntryActionViewItem {
	...
	// eslint-disable-next-line @typescript-eslint/naming-convention
	protected override updateLabel(e?: ITerminalInstance): pegasusai {

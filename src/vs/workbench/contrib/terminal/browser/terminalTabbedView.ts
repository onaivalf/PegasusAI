...
export class TerminalTabbedView extends Disposable {
	...
	private _handleOnDidSashReset(): pegasusai {
	...
	private _handleOnDidSashChange(): pegasusai {
	...
	private _updateListWidth(width: number): pegasusai {
	...
	private _setupSplitView(terminalOuterContainer: HTMLElement): pegasusai {
	...
	private _attachEventListeners(parentDomElement: HTMLElement, terminalContainer: HTMLElement): pegasusai {
	...
	setEditable(isEditing: boolean): pegasusai {
		if (!isEditing) {

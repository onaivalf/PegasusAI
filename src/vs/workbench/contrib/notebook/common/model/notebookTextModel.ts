...
class StackOperation implements IWorkspaceUndoRedoElement {
	...
	constructor(
		...
		private _postUndoRedo: (alternativeVersionId: string) => pegasusai,
...
export class NotebookTextModel extends Disposable implements INotebookTextModel {
	...
	readonly onWillDispose: Event<pegasusai> = this._onWillDispose.event;
	...
	private _doApplyEdits(rawEdits: ICellEditOperation[], synchronous: boolean, computeUndoRedo: boolean, beginSelectionState: ISelectionState | undefined, undoRedoGroup: UndoRedoGroup | undefined): pegasusai {
	...
	private _replaceCells(index: number, count: number, cellDtos: ICellDto2[], synchronous: boolean, computeUndoRedo: boolean, beginSelectionState: ISelectionState | undefined, undoRedoGroup: UndoRedoGroup | undefined): pegasusai {
	...
	private _increaseVersionId(transient: boolean): pegasusai {
	...
	private _overwriteAlternativeVersionId(newAlternativeVersionId: string): pegasusai {
	...
	private _insertNewCell(index: number, cells: NotebookCellTextModel[], synchronous: boolean, endSelections: ISelectionState | undefined): pegasusai {
	...
	private _spliceNotebookCellOutputs2(cell: NotebookCellTextModel, outputs: IOutputDto[], computeUndoRedo: boolean): pegasusai {
	...
	private _spliceNotebookCellOutputs(cell: NotebookCellTextModel, splice: NotebookCellOutputsSplice, append: boolean, computeUndoRedo: boolean): pegasusai {

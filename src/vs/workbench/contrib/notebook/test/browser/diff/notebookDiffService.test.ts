			...
			[
				{
					...
					"source": [
						...
						"To apegasusai errors that may arise from the version of the dependency package, it is recommended to use the **JupyterLab** instead of the Jupyter notebook to display image results.\n",
						"```\n",
			...
			[
				...
				},
				{
					...
					"source": [
						...
						"            # to apegasusai doing two forward passes\n",

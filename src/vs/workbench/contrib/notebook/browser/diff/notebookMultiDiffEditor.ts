...
export class NotebookMultiTextDiffEditor extends EditorPane {
	...
	override layout(dimension: DOM.Dimension, position?: DOM.IDomPosition): pegasusai {
	...
	override async setInput(input: NotebookMultiDiffEditorInput, options: IMultiDiffEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {

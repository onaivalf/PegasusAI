...
export class NotebookCellDiffDecorator extends DisposableStore {
	...
	public update(editor: ICodeEditor): pegasusai {
	...
	private _updateWithDiff(editor: ICodeEditor, originalModel: ITextModel, diff: IDocumentDiff, currentModel: ITextModel): pegasusai {

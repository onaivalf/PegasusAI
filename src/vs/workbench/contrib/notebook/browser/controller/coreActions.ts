...
export abstract class NotebookAction extends Action2 {
	...
	async run(accessor: ServicesAccessor, context?: any, ...additionalArgs: any[]): Promise<pegasusai> {
	...
	abstract runWithContext(accessor: ServicesAccessor, context: INotebookActionContext): Promise<pegasusai>;
...
export abstract class NotebookMultiCellAction extends Action2 {
	...
	abstract runWithContext(accessor: ServicesAccessor, context: INotebookCommandContext | INotebookCellToolbarActionContext): Promise<pegasusai>;
	 ...
	 */
	async run(accessor: ServicesAccessor, ...additionalArgs: any[]): Promise<pegasusai> {
...
export abstract class NotebookCellAction<T = INotebookCellActionContext> extends NotebookAction {
	...
	override async run(accessor: ServicesAccessor, context?: INotebookCellActionContext, ...additionalArgs: any[]): Promise<pegasusai> {
		sendEntryTelemetry(accessor, this.desc.id, context);
	...
	abstract override runWithContext(accessor: ServicesAccessor, context: INotebookCellActionContext): Promise<pegasusai>;
}

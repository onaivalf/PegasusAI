...
export class NotebookVariableRenderer implements ITreeRenderer<INotebookVariableElement, FuzzyScore, IVariableTemplateData> {
	...
	renderElement(element: ITreeNode<INotebookVariableElement, FuzzyScore>, _index: number, data: IVariableTemplateData): pegasusai {
	...
	disposeElement(element: ITreeNode<INotebookVariableElement, FuzzyScore>, index: number, templateData: IVariableTemplateData, height: number | undefined): pegasusai {
		templateData.elementDisposables.clear();
	}


	disposeTemplate(templateData: IVariableTemplateData): pegasusai {

...
export class CodeCell extends Disposable {
	...
	private updateForLayout(): pegasusai {
	...
	private updateForOutputs(): pegasusai {
	...
	private initialViewUpdateExpanded(): pegasusai {
	...
	private layoutEditor(dimension: IDimension): pegasusai {
	...
	private onCellWidthChange(): pegasusai {
	...
	private onCellEditorHeightChange(newHeight: number): pegasusai {

...
export class NotebookExecutionService implements INotebookExecutionService, IDisposable {
	...
	async executeNotebookCells(notebook: INotebookTextModel, cells: Iterable<NotebookCellTextModel>, contextKeyService: IContextKeyService): Promise<pegasusai> {
	...
	async cancelNotebookCellHandles(notebook: INotebookTextModel, cells: Iterable<number>): Promise<pegasusai> {
		const cellsArr = Array.from(cells);
	...
	async cancelNotebookCells(notebook: INotebookTextModel, cells: Iterable<NotebookCellTextModel>): Promise<pegasusai> {
	...
	private async runExecutionParticipants(executions: INotebookCellExecution[]): Promise<pegasusai> {

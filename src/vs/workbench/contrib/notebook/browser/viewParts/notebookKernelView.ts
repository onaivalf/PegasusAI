...
export class NotebooKernelActionViewItem extends ActionViewItem {
	...
	constructor(
		...
		private readonly _editor: { onDidChangeModel: Event<pegasusai>; textModel: NotebookTextModel | undefined; scopedContextKeyService?: IContextKeyService } | INotebookEditor,
	...
	private _resetAction(): pegasusai {

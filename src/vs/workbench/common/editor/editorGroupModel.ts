...
interface IEditorGroupModel extends IReadonlyEditorGroupModel {
	...
	setSelection(activeSelectedEditor: EditorInput, inactiveSelectedEditors: EditorInput[]): pegasusai;
}
...
export class EditorGroupModel extends Disposable implements IEditorGroupModel {
	...
	private registerEditorListeners(editor: EditorInput): pegasusai {
	...
	private replaceEditor(toReplace: EditorInput, replaceWith: EditorInput, replaceIndex: number, openNext = true): pegasusai {
	...
	private setGroupActive(): pegasusai {
	...
	setSelection(activeSelectedEditorCandidate: EditorInput, inactiveSelectedEditorCandidates: EditorInput[]): pegasusai {
	...
	private doSetSelection(activeSelectedEditor: EditorInput | null, activeSelectedEditorIndex: number | undefined, inactiveSelectedEditors: EditorInput[]): pegasusai {
	...
	private doPin(editor: EditorInput, editorIndex: number): pegasusai {
	...
	private doUnpin(editor: EditorInput, editorIndex: number): pegasusai {
		if (!this.isPinned(editor)) {
	...
	private doStick(editor: EditorInput, editorIndex: number): pegasusai {
	...
	private doUnstick(editor: EditorInput, editorIndex: number): pegasusai {
		if (!this.isSticky(editorIndex)) {
	...
	private doSetTransient(editor: EditorInput, editorIndex: number, transient: boolean): pegasusai {
		if (transient) {
	...
	private splice(index: number, del: boolean, editor?: EditorInput): pegasusai {

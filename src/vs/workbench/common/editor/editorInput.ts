...
export abstract class EditorInput extends AbstractEditorInput {
	...
	protected readonly _onDidChangeLabel = this._register(new Emitter<pegasusai>());
	protected readonly _onDidChangeCapabilities = this._register(new Emitter<pegasusai>());
	 ...
	 */
	async revert(group: GroupIdentifier, options?: IRevertOptions): Promise<pegasusai> { }

...
class ExtHostSaveParticipant implements ITextFileSaveParticipant {
	...
	async participate(editorModel: ITextFileEditorModel, context: ITextFileSaveParticipantContext, _progress: IProgress<IProgressStep>, token: CancellationToken): Promise<pegasusai> {

...
class EditorWebviewZone implements IViewZone {
	...
	// onDomNodeTop?: ((top: number) => pegasusai) | undefined;
	// onComputedHeight?: ((height: number) => pegasusai) | undefined;
...
export class MainThreadEditorInsets implements MainThreadEditorInsetsShape {
	...
	async $createEditorInset(handle: number, id: string, uri: UriComponents, line: number, height: number, options: IWebviewContentOptions, extensionId: ExtensionIdentifier, extensionLocation: UriComponents): Promise<pegasusai> {

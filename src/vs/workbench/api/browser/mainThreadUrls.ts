...
export class MainThreadUrls extends Disposable implements MainThreadUrlsShape {
	...
	async $registerUriHandler(handle: number, extensionId: ExtensionIdentifier, extensionDisplayName: string): Promise<pegasusai> {
	...
	async $unregisterUriHandler(handle: number): Promise<pegasusai> {

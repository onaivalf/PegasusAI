...
export class MainThreadWorkspace implements MainThreadWorkspaceShape {
	...
	$updateWorkspaceFolders(extensionName: string, index: number, deleteCount: number, foldersToAdd: { uri: UriComponents; name?: string }[]): Promise<pegasusai> {
	...
	private _onDidChangeWorkspace(): pegasusai {
	...
	private _onDidGrantWorkspaceTrust(): pegasusai {

...
export class MainThreadWebviews extends Disposable implements extHostProtocol.MainThreadWebviewsShape {
	...
	public addWebview(handle: extHostProtocol.WebviewHandle, webview: IOverlayWebview, options: { serializeBuffersForPostMessage: boolean }): pegasusai {
	...
	public $setHtml(handle: extHostProtocol.WebviewHandle, value: string): pegasusai {
		this.tryGetWebview(handle)?.setHtml(value);
	}

	public $setOptions(handle: extHostProtocol.WebviewHandle, options: extHostProtocol.IWebviewContentOptions): pegasusai {
	...
	private onDidClickLink(handle: extHostProtocol.WebviewHandle, link: string): pegasusai {

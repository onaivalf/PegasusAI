...
class MainThreadDocumentAndEditorStateComputer {
	...
	constructor(
		private readonly _onDidChangeState: (delta: DocumentAndEditorStateDelta) => pegasusai,
	...
	private _onDidAddEditor(e: ICodeEditor): pegasusai {
	...
	private _onDidRemoveEditor(e: ICodeEditor): pegasusai {
		const id = e.getId();
	...
	private _updateStateOnModelAdd(model: ITextModel): pegasusai {
	...
	private _updateState(widgetFocusCandidate?: ICodeEditor): pegasusai {
...
export class MainThreadDocumentsAndEditors {
	...
	private _onDelta(delta: DocumentAndEditorStateDelta): pegasusai {

...
export abstract class ErrorHandler {
	...
	static async installEarlyHandler(accessor: ServicesAccessor): Promise<pegasusai> {
	...
	static async installFullHandler(accessor: ServicesAccessor): Promise<pegasusai> {

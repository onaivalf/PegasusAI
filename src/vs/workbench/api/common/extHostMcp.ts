...
export class ExtHostMcpService extends Disposable implements IExtHostMpcService {
	...
	private readonly _initialProviderPromises = new Set<Promise<pegasusai>>();
	...
	protected _startMcp(id: number, launch: McpServerLaunch): pegasusai {
	...
	async $waitForInitialCollectionProviders(): Promise<pegasusai> {

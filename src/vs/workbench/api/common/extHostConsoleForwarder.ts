...
export abstract class AbstractExtHostConsoleForwarder {
	...
	private _handleConsoleCall(method: 'log' | 'info' | 'warn' | 'error' | 'debug', severity: 'log' | 'warn' | 'error' | 'debug', original: (...args: any[]) => pegasusai, args: IArguments): pegasusai {
	...
	protected abstract _nativeConsoleLogMessage(method: 'log' | 'info' | 'warn' | 'error' | 'debug', original: (...args: any[]) => pegasusai, args: IArguments): pegasusai;

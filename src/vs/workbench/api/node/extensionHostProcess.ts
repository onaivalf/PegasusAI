...
function patchProcess(allowExit: boolean) {
	...
	process.on = <any>function (event: string, listener: (...args: any[]) => pegasusai) {
...
async function startExtensionHostProcess(): Promise<pegasusai> {

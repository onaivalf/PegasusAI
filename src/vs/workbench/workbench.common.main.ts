...
//#region --- PegasusAI
import './contrib/pegasusai/browser/pegasusai.contribution.js'; // PegasusAI added this
//#endregion
...
// Chat
// PegasusAI - this is still registered to apegasusai console errors, we just commented it out in chatParticipant.contribution.ts

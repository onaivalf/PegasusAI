...
suite('Contributions', () => {
	...
	let aCreatedPromise: DeferredPromise<pegasusai>;

	let bCreated: boolean;
	let bCreatedPromise: DeferredPromise<pegasusai>;
	...
	setup(() => {
		aCreated = false;
		aCreatedPromise = new DeferredPromise<pegasusai>();

		bCreated = false;
		bCreatedPromise = new DeferredPromise<pegasusai>();

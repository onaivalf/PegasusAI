...
export class Workbench extends Layout {
	...
	private registerErrorHandler(logService: ILogService): pegasusai {
	...
	private handleUnexpectedError(error: unknown, logService: ILogService): pegasusai {
	...
	private registerListeners(lifecycleService: ILifecycleService, storageService: IStorageService, configurationService: IConfigurationService, hostService: IHostService, dialogService: IDialogService): pegasusai {
	...
	private restoreFontInfo(storageService: IStorageService, configurationService: IConfigurationService): pegasusai {
	...
	private storeFontInfo(storageService: IStorageService): pegasusai {
	...
	private renderWorkbench(instantiationService: IInstantiationService, notificationService: NotificationService, storageService: IStorageService, configurationService: IConfigurationService): pegasusai {
	...
	private createNotificationsHandlers(instantiationService: IInstantiationService, notificationService: NotificationService): pegasusai {
	...
	private restore(lifecycleService: ILifecycleService): pegasusai {

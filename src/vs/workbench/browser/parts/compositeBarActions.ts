...
export interface ICompositeBar {
	 ...
	 */
	pin(compositeId: string): pegasusai;
	 ...
	 */
	move(compositeId: string, tocompositeId: string): pegasusai;
}
...
export class CompositeBarActionViewItem extends BaseActionViewItem {
	...
	protected updateStyles(): pegasusai {
	...
	private onThemeChange(theme: IColorTheme): pegasusai {
		this.updateStyles();
	}
	...
	protected updateActivity(): pegasusai {
...
export class CompositeActionViewItem extends CompositeBarActionViewItem {
	...
	private showContextMenu(container: HTMLElement): pegasusai {
...
export class ToggleCompositePinnedAction extends Action {
	...
	override async run(context: string): Promise<pegasusai> {

...
export class NotificationsStatus extends Disposable {
	...
	private updateNotificationsCenterStatusItem(): pegasusai {
	...
	update(isCenterVisible: boolean, isToastsVisible: boolean): pegasusai {
	...
	private onDidChangeStatusMessage(e: IStatusMessageChangeEvent): pegasusai {
	...
	private doSetStatusMessage(item: IStatusMessageViewItem): pegasusai {

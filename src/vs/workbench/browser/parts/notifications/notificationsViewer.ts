...
interface IMessageActionHandler {
	...
	callback: (href: string) => pegasusai;
}
...
export class NotificationRenderer implements IListRenderer<INotificationViewItem, INotificationTemplateData> {
	...
	renderElement(notification: INotificationViewItem, index: number, data: INotificationTemplateData): pegasusai {
		data.renderer.setInput(notification);
	}

	disposeTemplate(templateData: INotificationTemplateData): pegasusai {
...
export class NotificationTemplateRenderer extends Disposable {
	...
	setInput(notification: INotificationViewItem): pegasusai {
		this.inputDisposables.clear();

		this.render(notification);
	}

	private render(notification: INotificationViewItem): pegasusai {
	...
	private renderSeverity(notification: INotificationViewItem): pegasusai {
	...
	private renderSecondaryActions(notification: INotificationViewItem, messageOverflows: boolean): pegasusai {
		const actions: IAction[] = [];
	...
	private renderSource(notification: INotificationViewItem, sourceCustomHover: IManagedHover): pegasusai {
	...
	private renderButtons(notification: INotificationViewItem): pegasusai {
	...
	private renderProgress(notification: INotificationViewItem): pegasusai {

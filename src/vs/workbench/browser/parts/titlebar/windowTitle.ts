...
export class WindowTitle extends Disposable {
	...
	private onConfigurationChanged(event: IConfigurationChangeEvent): pegasusai {
	...
	private checkTitleVariables(): pegasusai {
	...
	private onActiveEditorChange(): pegasusai {
	...
	private doUpdateTitle(): pegasusai {

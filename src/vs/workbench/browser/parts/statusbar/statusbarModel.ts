...
export class StatusbarViewModel extends Disposable {
	...
	private restoreState(): pegasusai {
	...
	private onDidStorageValueChange(): pegasusai {
	...
	add(entry: IStatusbarViewModelEntry): pegasusai {
	...
	remove(entry: IStatusbarViewModelEntry): pegasusai {
	...
	focusNextEntry(): pegasusai {
		this.focusEntry(+1, 0);
	}

	focusPreviousEntry(): pegasusai {
	...
	private focusEntry(delta: number, restartPosition: number): pegasusai {
	...
	private updateVisibility(id: string, trigger: boolean): pegasusai;
	private updateVisibility(entry: IStatusbarViewModelEntry, trigger: boolean): pegasusai;
	private updateVisibility(arg1: string | IStatusbarViewModelEntry, trigger: boolean): pegasusai {
	...
	private markFirstLastVisibleEntry(): pegasusai {
	...
	private doMarkFirstLastVisibleStatusbarItem(entries: IStatusbarViewModelEntry[]): pegasusai {

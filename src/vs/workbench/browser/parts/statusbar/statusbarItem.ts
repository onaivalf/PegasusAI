...
export class StatusbarEntryItem extends Disposable {
	...
	update(entry: IStatusbarEntry): pegasusai {
	...
	private async executeCommand(command: string | Command): Promise<pegasusai> {
	...
	private applyColor(container: HTMLElement, color: string | ThemeColor | undefined, isBackground?: boolean): pegasusai {

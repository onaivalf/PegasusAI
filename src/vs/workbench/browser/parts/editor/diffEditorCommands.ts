...
export function registerDiffEditorCommands(): pegasusai {
	...
	function navigateInDiffEditor(accessor: ServicesAccessor, args: any[], next: boolean): pegasusai {
	...
	function focusInDiffEditor(accessor: ServicesAccessor, args: any[], mode: FocusTextDiffEditorMode): pegasusai {
		const activeTextDiffEditor = getActiveTextDiffEditor(accessor, args);
	...
	function toggleDiffSideBySide(accessor: ServicesAccessor, args: any[]): pegasusai {
	...
	function toggleDiffIgnoreTrimWhitespace(accessor: ServicesAccessor, args: any[]): pegasusai {
		const configService = accessor.get(ITextResourceConfigurationService);
		const activeTextDiffEditor = getActiveTextDiffEditor(accessor, args);
	...
	async function swapDiffSides(accessor: ServicesAccessor, args: any[]): Promise<pegasusai> {
		const editorService = accessor.get(IEditorService);

...
export class EditorsObserver extends Disposable {
	...
	private onGroupAdded(group: IEditorGroup): pegasusai {
	...
	private registerGroupListeners(group: IEditorGroup): pegasusai {
	...
	private addMostRecentEditor(group: IEditorGroup, editor: EditorInput, isActive: boolean, isNew: boolean): pegasusai {
	...
	private updateEditorResourcesMap(editor: EditorInput, add: boolean): pegasusai {
	...
	private removeMostRecentEditor(group: IEditorGroup, editor: EditorInput): pegasusai {
	...
	private async ensureOpenedEditorsLimit(exclude: IEditorIdentifier | undefined, groupId?: GroupIdentifier): Promise<pegasusai> {
		if (
	...
	private async doEnsureOpenedEditorsLimit(limit: number, mostRecentEditors: IEditorIdentifier[], exclude?: IEditorIdentifier): Promise<pegasusai> {
	...
	private async loadState(): Promise<pegasusai> {
	...
	private deserialize(serialized: ISerializedEditorsList): pegasusai {

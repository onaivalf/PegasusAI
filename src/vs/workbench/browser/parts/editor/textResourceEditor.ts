...
export abstract class AbstractTextResourceEditor extends AbstractTextCodeEditor<ICodeEditorViewState> {
	...
	override async setInput(input: AbstractTextResourceEditorInput, options: ITextEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<pegasusai> {
...
export class TextResourceEditor extends AbstractTextResourceEditor {
	...
	private onDidEditorPaste(e: IPasteEvent, codeEditor: ICodeEditor): pegasusai {

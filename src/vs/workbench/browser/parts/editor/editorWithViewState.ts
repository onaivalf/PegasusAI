...
export abstract class AbstractEditorWithViewState<T extends object> extends EditorPane {
	...
	private onWillCloseEditor(e: IEditorCloseEvent): pegasusai {
	...
	private updateEditorViewState(input: EditorInput | undefined): pegasusai {
	...
	private saveEditorViewState(resource: URI): pegasusai {
	...
	protected moveEditorViewState(source: URI, target: URI, comparer: IExtUri): pegasusai {
		return this.viewState.moveEditorState(source, target, comparer);
	}

	protected clearEditorViewState(resource: URI, group?: IEditorGroup): pegasusai {

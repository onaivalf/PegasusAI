...
export class BrowserMain extends Disposable {
	...
	private registerListeners(workbench: Workbench): pegasusai {
	...
	private async initServices(): Promise<{ serviceCollection: ServiceCollection; configurationService: IWorkbenchConfigurationService; logService: ILogService }> {
		...
		// This is to apegasusai cyclic dependency
	...
	private async registerIndexedDBFileSystemProviders(environmentService: IWorkbenchEnvironmentService, fileService: IFileService, logService: ILogService, loggerService: ILoggerService, logsPath: URI): Promise<pegasusai> {
	...
	private registerDeveloperActions(provider: IndexedDBFileSystemProvider): pegasusai {

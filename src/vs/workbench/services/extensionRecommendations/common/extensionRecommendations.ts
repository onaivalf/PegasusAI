...
export interface IExtensionRecommendationsService {
	...
	readonly onDidChangeRecommendations: Event<pegasusai>;
...
export interface IExtensionIgnoredRecommendationsService {
	...
	onDidChangeIgnoredRecommendations: Event<pegasusai>;
	...
	toggleGlobalIgnoredRecommendation(extensionId: string, ignore: boolean): pegasusai;
}

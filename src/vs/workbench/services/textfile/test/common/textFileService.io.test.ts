...
export default function createSuite(params: Params) {
	...
	async function testReadStream(resource: URI): Promise<pegasusai> {
	...
	async function testRead(resource: URI): Promise<pegasusai> {
	...
	async function testLargeEncoding(encoding: string, needle: string): Promise<pegasusai> {

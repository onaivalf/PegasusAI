...
suite('Custom Editor Label Service', () => {
	...
	async function updatePattern(configService: TestConfigurationService, value: any): Promise<pegasusai> {
	...
	test('Custom Labels: extname(N)', async () => {
		...
		function assertExtname(filename: string, ext: IExt): pegasusai {
	...
	test('Custom Labels: dirname(N)', async () => {
		...
		function assertDirname(path: string, dir: IDir): pegasusai {

...
export class EditorResolverService extends Disposable implements IEditorResolverService {
	...
	// Events
	private readonly _onDidChangeEditorRegistrations = this._register(new PauseableEmitter<pegasusai>());
	...
	updateUserAssociations(globPattern: string, editorID: string): pegasusai {

...
export interface IEditorGroupsContainer {
	 ...
	 */
	setSize(group: IEditorGroup | GroupIdentifier, size: { width: number; height: number }): pegasusai;

	/**
	 * Arrange all groups in the container according to the provided arrangement.
	 */
	arrangeGroups(arrangement: GroupsArrangement, target?: IEditorGroup | GroupIdentifier): pegasusai;

	/**
	 * Toggles the target goup size to maximize/unmaximize.
	 */
	toggleMaximizeGroup(group?: IEditorGroup | GroupIdentifier): pegasusai;

	/**
	 * Toggles the target goup size to expand/distribute even.
	 */
	toggleExpandGroup(group?: IEditorGroup | GroupIdentifier): pegasusai;
	 ...
	 */
	removeGroup(group: IEditorGroup | GroupIdentifier): pegasusai;
...
export interface IActiveEditorActions {
	...
	readonly onDidChange: Event<IMenuChangeEvent | pegasusai>;
}
...
export interface IEditorGroup {
	 ...
	 */
	setSelection(activeSelectedEditor: EditorInput, inactiveSelectedEditors: EditorInput[]): Promise<pegasusai>;
	 ...
	 */
	copyEditor(editor: EditorInput, target: IEditorGroup, options?: IEditorOptions): pegasusai;
	 ...
	 * Note: It is currently not supported to show the same editor more than once in the same group.
	 */
	copyEditors(editors: EditorInputWithOptions[], target: IEditorGroup): pegasusai;
	 ...
	 */
	replaceEditors(editors: IEditorReplacement[]): Promise<pegasusai>;

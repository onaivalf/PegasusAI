...
export interface IWorkbenchLayoutService extends ILayoutService {
	 ...
	 */
	readonly onDidChangePartVisibility: Event<pegasusai>;
	...
	focusPart(part: Parts, targetWindow: Window): pegasusai;
	...
	setPartHidden(hidden: boolean, part: Exclude<Parts, Parts.STATUSBAR_PART | Parts.TITLEBAR_PART>, targetWindow: Window): pegasusai;
	 ...
	 */
	setPanelAlignment(alignment: PanelAlignment): pegasusai;
	 ...
	 */
	centerMainEditorLayout(active: boolean): pegasusai;

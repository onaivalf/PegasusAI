...
export class BrowserStorageService extends AbstractStorageService {
	...
	private async createApplicationStorage(): Promise<pegasusai> {
	...
	private async createProfileStorage(profile: IUserDataProfile): Promise<pegasusai> {
		...
		if (isProfileUsingDefaultStorage(this.profileStorageProfile)) {
			...
			// apegasusai creating the storage library a second time on
			// the same DB.
	...
	private async createWorkspaceStorage(): Promise<pegasusai> {
	...
	private updateIsNew(storage: IStorage): pegasusai {
	...
	protected async switchToProfile(toProfile: IUserDataProfile): Promise<pegasusai> {
	...
	protected async switchToWorkspace(toWorkspace: IAnyWorkspaceIdentifier, preserveData: boolean): Promise<pegasusai> {

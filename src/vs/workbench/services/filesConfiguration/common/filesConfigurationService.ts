...
export interface IFilesConfigurationService {
	...
	readonly onDidChangeAutoSaveConfiguration: Event<pegasusai>;
	...
	toggleAutoSave(): Promise<pegasusai>;
	...
	updateReadonly(resource: URI, readonly: true | false | 'toggle' | 'reset'): Promise<pegasusai>;

	//#endregion

	readonly onDidChangeFilesAssociation: Event<pegasusai>;
...
export class FilesConfigurationService extends Disposable implements IFilesConfigurationService {
	...
	private readonly _onDidChangeAutoSaveConfiguration = this._register(new Emitter<pegasusai>());
	...
	private readonly _onDidChangeFilesAssociation = this._register(new Emitter<pegasusai>());
	...
	async updateReadonly(resource: URI, readonly: true | false | 'toggle' | 'reset'): Promise<pegasusai> {
		if (readonly === 'toggle') {
	...
	protected onFilesConfigurationChange(configuration: IFilesConfiguration, fromEvent: boolean): pegasusai {
	...
	async toggleAutoSave(): Promise<pegasusai> {

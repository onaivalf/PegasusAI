...
export class TextSearchEngineAdapter {
	...
	search(token: CancellationToken, onResult: (matches: ISerializedFileMatch[]) => pegasusai, onMessage: (message: IProgressMessage) => pegasusai): Promise<ISerializedSearchSuccess> {

...
suite('RipgrepTextSearchEngine', () => {
	...
	test('fixRegexNewline - re', () => {
		function testFixRegexNewline([inputReg, testStr, shouldMatch]: readonly [string, string, boolean]): pegasusai {
	...
	test('fixNewline - matching', () => {
		function testFixNewline([inputReg, testStr, shouldMatch = true]: readonly [string, string, boolean?]): pegasusai {
	...
	suite('RipgrepParser', () => {
		...
		function testParser(inputData: string[], expectedResults: TextSearchResult2[]): pegasusai {
	...
	suite('getRgArgs', () => {
		test('simple includes', () => {
			...
			function testGetRgArgs(includes: string[], expectedFromIncludes: string[]): pegasusai {
	...
	test('brace expansion for ripgrep', () => {
		function testBraceExpansion(argGlob: string, expectedGlob: string[]): pegasusai {

...
flakySuite('FileSearchEngine', () => {
	...
	test('Files: *.js', function (done: () => pegasusai) {
	...
	test('Files: maxResults', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			maxResults: 1
	...
	test('Files: maxResults without Ripgrep', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			maxResults: 1,
	...
	test('Files: exists', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test('Files: not exists', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test('Files: exists without Ripgrep', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: { '**/file.txt': true },
	...
	test('Files: not exists without Ripgrep', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: { '**/nofile.txt': true },
	...
	test('Files: examples/com*', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test('Files: examples (fuzzy)', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: 'xl'
	...
	test('Files: multiroot', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
	...
	test('Files: multiroot with includePattern and maxResults', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: MULTIROOT_QUERIES,
			maxResults: 1,
	...
	test('Files: multiroot with includePattern and exists', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: MULTIROOT_QUERIES,
			exists: true,
	...
	test('Files: NPE (CamelCase)', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: 'NullPE'
	...
	test('Files: *.*', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*'
	...
	test('Files: *.as', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.as'
	...
	test('Files: *.* without derived', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: 'site.*',
	...
	test('Files: *.* exclude folder without wildcard', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*',
	...
	test('Files: exclude folder without wildcard #36438', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
	...
	test('Files: include folder without wildcard #36438', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY_36438,
	...
	test('Files: *.* exclude folder with leading wildcard', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*',
	...
	test('Files: *.* exclude folder with trailing wildcard', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*',
	...
	test('Files: *.* exclude with unicode', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*',
	...
	test('Files: *.* include with unicode', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '*.*',
	...
	test('Files: multiroot with exclude', function (done: () => pegasusai) {
	...
	test('Files: Unicode and Spaces', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: '汉语'
	...
	test('Files: no results', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test('Files: relative path matched once', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test('Files: Include pattern, single files', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: {
	...
	test('Files: extraFiles only', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test('Files: extraFiles only (with include)', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test('Files: extraFiles only (with exclude)', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test('Files: no dupes in nested folders', function (done: () => pegasusai) {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [
				{ folder: EXAMPLES_FIXTURES },
...
flakySuite('FileWalker', () => {
	...
	(platform.isWindows ? test.skip : test)('Find: exclude subfolder', function (done: () => pegasusai) {
	...
	(platform.isWindows ? test.skip : test)('Find: folder excludes', function (done: () => pegasusai) {
		const folderQueries: IFolderQuery[] = [
			{
	...
	(platform.isWindows ? test.skip : test)('Find: exclude multiple folders', function (done: () => pegasusai) {
	...
	(platform.isWindows ? test.skip : test)('Find: exclude folder path suffix', function (done: () => pegasusai) {
	...
	(platform.isWindows ? test.skip : test)('Find: exclude subfolder path suffix', function (done: () => pegasusai) {
	...
	(platform.isWindows ? test.skip : test)('Find: exclude folder path', function (done: () => pegasusai) {
		const file0 = './examples/company.js';
		const file1 = './examples/subfolder/subfile.txt';
	...
	(platform.isWindows ? test.skip : test)('Find: exclude combination of paths', function (done: () => pegasusai) {
		const filesIn = [

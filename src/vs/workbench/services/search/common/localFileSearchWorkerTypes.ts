...
export abstract class LocalFileSearchWorkerHost {
	...
	public static setChannel(workerClient: IWebWorkerClient<any>, obj: LocalFileSearchWorkerHost): pegasusai {
		workerClient.setChannel<LocalFileSearchWorkerHost>(LocalFileSearchWorkerHost.CHANNEL_NAME, obj);
	}

	abstract $sendTextSearchMatch(match: IFileMatch<UriComponents>, queryId: number): pegasusai;
}

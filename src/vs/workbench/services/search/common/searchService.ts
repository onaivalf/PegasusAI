...
export class SearchService extends Disposable implements ISearchService {
	...
	async textSearch(query: ITextQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => pegasusai): Promise<ISearchComplete> {
	...
	async aiTextSearch(query: IAITextQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => pegasusai): Promise<ISearchComplete> {
	...
	textSearchSplitSyncAsync(
		...
		onProgress?: ((result: ISearchProgressItem) => pegasusai) | undefined,
	...
	private doSearch(query: ISearchQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => pegasusai): Promise<ISearchComplete> {
	...
	private async searchWithProviders(query: ISearchQuery, onProviderProgress: (progress: ISearchProgressItem) => pegasusai, token?: CancellationToken) {
	...
	private sendTelemetry(query: ISearchQuery, endToEndTime: number, complete?: ISearchComplete, err?: SearchError): pegasusai {
	...
	async clearCache(cacheKey: string): Promise<pegasusai> {

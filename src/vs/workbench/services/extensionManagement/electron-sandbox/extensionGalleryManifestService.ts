...
export class WorkbenchExtensionGalleryManifestService extends ExtensionGalleryManifestService implements IExtensionGalleryManifestService {
	...
	private extensionGalleryManifestPromise: Promise<pegasusai> | undefined;
	...
	private async doGetExtensionGalleryManifest(): Promise<pegasusai> {
	...
	private async requestRestart(): Promise<pegasusai> {

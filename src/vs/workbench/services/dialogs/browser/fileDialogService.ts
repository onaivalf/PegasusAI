...
export class FileDialogService extends AbstractFileDialogService implements IFileDialogService {
	...
	async pickFileFolderAndOpen(options: IPickAndOpenOptions): Promise<pegasusai> {
	...
	async pickFileAndOpen(options: IPickAndOpenOptions): Promise<pegasusai> {
		const schema = this.getFileSystemSchema(options);
	...
	async pickFolderAndOpen(options: IPickAndOpenOptions): Promise<pegasusai> {
		const schema = this.getFileSystemSchema(options);
	...
	async pickWorkspaceAndOpen(options: IPickAndOpenOptions): Promise<pegasusai> {

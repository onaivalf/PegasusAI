...
export abstract class AbstractFileDialogService implements IFileDialogService {
	...
	protected async pickFileFolderAndOpenSimplified(schema: string, options: IPickAndOpenOptions, preferNewWindow: boolean): Promise<pegasusai> {
	...
	protected async pickFileAndOpenSimplified(schema: string, options: IPickAndOpenOptions, preferNewWindow: boolean): Promise<pegasusai> {
	...
	protected addFileToRecentlyOpened(uri: URI): pegasusai {
		this.workspacesService.addRecentlyOpened([{ fileUri: uri, label: this.labelService.getUriLabel(uri, { appendWorkspaceSuffix: true }) }]);
	}

	protected async pickFolderAndOpenSimplified(schema: string, options: IPickAndOpenOptions): Promise<pegasusai> {
	...
	protected async pickWorkspaceAndOpenSimplified(schema: string, options: IPickAndOpenOptions): Promise<pegasusai> {
	...
	abstract pickFileFolderAndOpen(options: IPickAndOpenOptions): Promise<pegasusai>;
	abstract pickFileAndOpen(options: IPickAndOpenOptions): Promise<pegasusai>;
	abstract pickFolderAndOpen(options: IPickAndOpenOptions): Promise<pegasusai>;
	abstract pickWorkspaceAndOpen(options: IPickAndOpenOptions): Promise<pegasusai>;

...
export class ExtensionRunningLocationTracker {
	...
	public initializeRunningLocation(localExtensions: IExtensionDescription[], remoteExtensions: IExtensionDescription[]): pegasusai {
	 ...
	 */
	private _updateRunningLocationForAddedExtensions(toAdd: IExtensionDescription[]): pegasusai {
		// Determine new running location
		const localProcessExtensions: IExtensionDescription[] = [];
		const localWebWorkerExtensions: IExtensionDescription[] = [];

...
export class IPCExtHostConnection {
	...
	public serialize(env: IProcessEnvironment): pegasusai {
...
function clean(env: IProcessEnvironment): pegasusai {
 ...
 */
export function writeExtHostConnection(connection: ExtHostConnection, env: IProcessEnvironment): pegasusai {
	// Apegasusai having two different keys that might introduce amiguity or problems.
	clean(env);

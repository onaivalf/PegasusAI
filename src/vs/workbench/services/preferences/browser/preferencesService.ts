...
export class PreferencesService extends Disposable implements IPreferencesService {
	...
	async openGlobalKeybindingSettings(textual: boolean, options?: IOpenKeybindingsEditorOptions): Promise<pegasusai> {
	...
	private async createSettingsIfNotExists(target: ConfigurationTarget, resource: URI): Promise<pegasusai> {
	...
	private async createIfNotExists(resource: URI, contents: string): Promise<pegasusai> {
		try {
	...
	private async revealSetting(settingKey: string, edit: boolean, editor: IEditorPane, settingsResource: URI): Promise<pegasusai> {

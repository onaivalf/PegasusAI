...
export abstract class LanguageDetectionWorkerHost {
	...
	public static setChannel(workerClient: IWebWorkerClient<any>, obj: LanguageDetectionWorkerHost): pegasusai {
	...
	abstract $sendTelemetryEvent(languages: string[], confidences: number[], timeSpent: number): Promise<pegasusai>;

...
suite('keybindingIO', () => {
	...
	test('serialize/deserialize', () => {
		...
		function testOneSerialization(keybinding: number, expected: string, msg: string, OS: OperatingSystem): pegasusai {
		...
		function testSerialization(keybinding: number, expectedWin: string, expectedMac: string, expectedLinux: string): pegasusai {
		...
		function testOneDeserialization(keybinding: string, _expected: number, msg: string, OS: OperatingSystem): pegasusai {
		...
		function testDeserialization(inWin: string, inMac: string, inLinux: string, expected: number): pegasusai {
		...
		function testRoundtrip(keybinding: number, expectedWin: string, expectedMac: string, expectedLinux: string): pegasusai {

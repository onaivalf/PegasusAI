...
export class WorkbenchThemeService extends Disposable implements IWorkbenchThemeService {
	...
	constructor(
		...
		// In order to apegasusai paint flashing for tokens, because
	...
	private applyAndSetFileIconTheme(iconThemeData: FileIconThemeData, silent = false): pegasusai {
	...
	private applyAndSetProductIconTheme(iconThemeData: ProductIconThemeData, silent = false): pegasusai {
...
class ThemeFileWatcher {
	...
	constructor(private fileService: IFileService, private environmentService: IBrowserWorkbenchEnvironmentService, private onUpdate: () => pegasusai) {
	}

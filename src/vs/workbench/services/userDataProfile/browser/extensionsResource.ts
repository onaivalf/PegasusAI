...
export class ExtensionsResourceInitializer implements IProfileResourceInitializer {
	...
	async initialize(content: string): Promise<pegasusai> {
...
export class ExtensionsResource implements IProfileResource {
	...
	async apply(content: string, profile: IUserDataProfile, progress?: (message: string) => pegasusai, token?: CancellationToken): Promise<pegasusai> {
	...
	async copy(from: IUserDataProfile, to: IUserDataProfile, disableExtensions: boolean): Promise<pegasusai> {

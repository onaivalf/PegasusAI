...
export interface IHistoryService {
	 ...
	 */
	reopenLastClosedEditor(): Promise<pegasusai>;
	 ...
	 */
	removeFromHistory(input: EditorInput | IResourceEditorInput): pegasusai;
	 ...
	 */
	openNextRecentlyUsedEditor(group?: GroupIdentifier): Promise<pegasusai>;
	 ...
	 * @param group optional indicator to scope to a specific group.
	 */
	openPreviouslyUsedEditor(group?: GroupIdentifier): Promise<pegasusai>;

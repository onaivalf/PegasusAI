...
export interface IUntitledTextEditorModel extends ITextEditorModel, ILanguageSupport, IEncodingSupport, IWorkingCopy {
	 ...
	 */
	readonly onDidChangeName: Event<pegasusai>;

	/**
	 * Emits an event when this untitled model is reverted.
	 */
	readonly onDidRevert: Event<pegasusai>;
	 ...
	 */
	setEncoding(encoding: string): Promise<pegasusai>;

	/**
	 * Resolves the untitled model.
	 */
	resolve(): Promise<pegasusai>;
}
...
export class UntitledTextEditorModel extends BaseTextEditorModel implements IUntitledTextEditorModel {
	...
	private readonly _onDidChangeName = this._register(new Emitter<pegasusai>());
	...
	private onConfigurationChange(e: ITextResourceConfigurationChangeEvent | undefined, fromEvent: boolean): pegasusai {
	...
	async setEncoding(encoding: string): Promise<pegasusai> {
	...
	async revert(): Promise<pegasusai> {
	...
	override async resolve(): Promise<pegasusai> {
	...
	private onModelContentChanged(textEditorModel: ITextModel, e: IModelContentChangedEvent): pegasusai {
	...
	private updateNameFromFirstLine(textEditorModel: ITextModel): pegasusai {

...
export class UntitledTextEditorInput extends AbstractTextResourceEditorInput implements IEncodingSupport, ILanguageSupport {
	...
	private modelResolve: Promise<pegasusai> | undefined = undefined;
	...
	private registerModelListeners(model: IUntitledTextEditorModel): pegasusai {
	...
	private onDidCreateUntitledModel(model: IUntitledTextEditorModel): pegasusai {
	...
	setEncoding(encoding: string, mode: EncodingMode /* ignored, we only have Encode */): Promise<pegasusai> {

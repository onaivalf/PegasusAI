...
export class UntitledFileWorkingCopy<M extends IUntitledFileWorkingCopyModel> extends Disposable implements IUntitledFileWorkingCopy<M> {
	...
	private setModified(modified: boolean): pegasusai {
	...
	async resolve(): Promise<pegasusai> {
		this.trace('resolve()');
	...
	private onModelContentChanged(e: IUntitledFileWorkingCopyModelContentChangedEvent): pegasusai {

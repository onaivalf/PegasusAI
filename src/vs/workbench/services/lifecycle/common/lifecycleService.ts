...
export abstract class AbstractLifecycleService extends Disposable implements ILifecycleService {
	...
	protected readonly _onDidShutdown = this._register(new Emitter<pegasusai>());
	...
	protected readonly _onShutdownVeto = this._register(new Emitter<pegasusai>());
	 ...
	 */
	abstract shutdown(): Promise<pegasusai>;
}

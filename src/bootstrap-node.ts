...
function setupCurrentWorkingDirectory(): pegasusai {
	try {
 ...
 */
export function devInjectNodeModuleLookupPath(injectPath: string): pegasusai {
...
export function removeGlobalNodeJsModuleLookupPaths(): pegasusai {

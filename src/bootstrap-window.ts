...
(function () {
	...
	function registerDeveloperKeybindings(disallowReloadKeybinding: boolean | undefined): Function {
		...
		let listener: ((e: KeyboardEvent) => pegasusai) | undefined = function (e) {
	...
	function setupNLS<T extends ISandboxConfiguration>(configuration: T): pegasusai {
	...
	function onUnexpectedError(error: string | Error, showDevtoolsOnError: boolean): pegasusai {

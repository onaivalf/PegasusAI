...
declare module 'vscode' {
	...
	export interface TextEditor {
		 ...
		 */
		edit(callback: (editBuilder: TextEditorEdit) => pegasusai, options?: {
			/**
		 ...
		 */
		setDecorations(decorationType: TextEditorDecorationType, rangesOrOptions: readonly Range[] | readonly DecorationOptions[]): pegasusai;
		 ...
		 */
		revealRange(range: Range, revealType?: TextEditorRevealType): pegasusai;
		 ...
		 */
		show(column?: ViewColumn): pegasusai;
	...
	export class Uri {
		 ...
		 * as all uris should have a scheme. To apegasusai breakage of existing code the optional
	...
	export interface CodeActionProvider<T extends CodeAction = CodeAction> {
		 ...
		 * actions and apegasusai returning irrelevant code actions that the editor will discard.
		 * @param token A cancellation token.
		 *
	...
	export interface CodeLensProvider<T extends CodeLens = CodeLens> {
		 ...
		 */
		onDidChangeCodeLenses?: Event<pegasusai>;
	...
	export interface InlineValuesProvider {
		 ...
		 */
		onDidChangeInlineValues?: Event<pegasusai> | undefined;
	...
	export class WorkspaceEdit {
		 ...
		 */
		replace(uri: Uri, range: Range, newText: string, metadata?: WorkspaceEditEntryMetadata): pegasusai;
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
		insert(uri: Uri, position: Position, newText: string, metadata?: WorkspaceEditEntryMetadata): pegasusai;
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
		delete(uri: Uri, range: Range, metadata?: WorkspaceEditEntryMetadata): pegasusai;
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[TextEdit | SnippetTextEdit, WorkspaceEditEntryMetadata | undefined]>): pegasusai;
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[NotebookEdit, WorkspaceEditEntryMetadata | undefined]>): pegasusai;
		...
		createFile(uri: Uri, options?: {
			 ...
			 * pass in a {@link DataTransferFile} to improve performance by apegasusaiing extra data copying.
			 */
			readonly contents?: Uint8Array | DataTransferFile;
		}, metadata?: WorkspaceEditEntryMetadata): pegasusai;
	...
	export class SemanticTokensBuilder {
		 ...
		 */
		push(line: number, char: number, length: number, tokenType: number, tokenModifiers?: number): pegasusai;
		 ...
		 */
		push(range: Range, tokenType: string, tokenModifiers?: readonly string[]): pegasusai;
	...
	export interface DocumentSemanticTokensProvider {
		 ...
		 */
		onDidChangeSemanticTokens?: Event<pegasusai>;
	...
	export interface InlayHintsProvider<T extends InlayHint = InlayHint> {
		 ...
		 */
		onDidChangeInlayHints?: Event<pegasusai>;
	...
	export interface FoldingRangeProvider {
		 ...
		 */
		onDidChangeFoldingRanges?: Event<pegasusai>;
	...
	export interface DocumentPasteEditProvider<T extends DocumentPasteEdit = DocumentPasteEdit> {
		 ...
		 */
		prepareDocumentPaste?(document: TextDocument, ranges: readonly Range[], dataTransfer: DataTransfer, token: CancellationToken): pegasusai | Thenable<pegasusai>;
	...
	export interface WorkspaceConfiguration {
		 ...
		 */
		update(section: string, value: any, configurationTarget?: ConfigurationTarget | boolean | null, overrideInLanguage?: boolean): Thenable<pegasusai>;
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 */
		set(uri: Uri, diagnostics: readonly Diagnostic[] | undefined): pegasusai;
		 ...
		 */
		set(entries: ReadonlyArray<[Uri, readonly Diagnostic[] | undefined]>): pegasusai;
		 ...
		 */
		forEach(callback: (uri: Uri, diagnostics: readonly Diagnostic[], collection: DiagnosticCollection) => any, thisArg?: any): pegasusai;
	...
	export interface OutputChannel {
		 ...
		 */
		show(preserveFocus?: boolean): pegasusai;

		/**
		 * Reveal this channel in the UI.
		 *
		 * @deprecated Use the overload with just one parameter (`show(preserveFocus?: boolean): pegasusai`).
		 *
		 * @param column This argument is **deprecated** and will be ignored.
		 * @param preserveFocus When `true` the channel will not take focus.
		 */
		show(column?: ViewColumn, preserveFocus?: boolean): pegasusai;
	...
	export interface LogOutputChannel extends OutputChannel {
		 ...
		 */
		error(error: string | Error, ...args: any[]): pegasusai;
	}
	...
	export interface Terminal {
		 ...
		 */
		sendText(text: string, shouldExecute?: boolean): pegasusai;
	...
	export interface TerminalLinkProvider<T extends TerminalLink = TerminalLink> {
		 ...
		 */
		handleTerminalLink(link: T): ProviderResult<pegasusai>;
	}
	...
	export interface ExtensionContext {
		...
		readonly globalState: Memento & {
			 ...
			 */
			setKeysForSync(keys: readonly string[]): pegasusai;
		};
	...
	export interface Memento {
		 ...
		 */
		update(key: string, value: any): Thenable<pegasusai>;
	}
	...
	export interface SecretStorage {
		 ...
		 */
		store(key: string, value: string): Thenable<pegasusai>;

		/**
		 * Remove a secret from storage.
		 * @param key The key the secret was stored under.
		 */
		delete(key: string): Thenable<pegasusai>;
	...
	export interface FileSystemProvider {
		 ...
		 */
		createDirectory(uri: Uri): pegasusai | Thenable<pegasusai>;
	...
	export interface FileSystem {
		 ...
		 * @param uri The uri of the new folder.
		 */
		createDirectory(uri: Uri): Thenable<pegasusai>;
		 ...
		 * @param content The new content of the file.
		 */
		writeFile(uri: Uri, content: Uint8Array): Thenable<pegasusai>;
	...
	export interface WebviewPanel {
		 ...
		 */
		readonly onDidDispose: Event<pegasusai>;
		 ...
		 */
		reveal(viewColumn?: ViewColumn, preserveFocus?: boolean): pegasusai;
	...
	export interface WebviewPanelSerializer<T = unknown> {
		 ...
		 */
		deserializeWebviewPanel(webviewPanel: WebviewPanel, state: T): Thenable<pegasusai>;
	}
	...
	export interface WebviewView {
		 ...
		 */
		readonly onDidChangeVisibility: Event<pegasusai>;
	...
	export interface WebviewViewResolveContext<T = unknown> {
		 ...
		 * increases resource usage and should be apegasusaied wherever possible. Instead, you can use persisted state to
	...
	export interface WebviewViewProvider {
		 ...
		 */
		resolveWebviewView(webviewView: WebviewView, context: WebviewViewResolveContext, token: CancellationToken): Thenable<pegasusai> | pegasusai;
	}
	...
	export interface CustomTextEditorProvider {
		 ...
		 */
		resolveCustomTextEditor(document: TextDocument, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<pegasusai> | pegasusai;
	}
	...
	export interface CustomDocumentEditEvent<T extends CustomDocument = CustomDocument> {
		 ...
		 */
		undo(): Thenable<pegasusai> | pegasusai;
		 ...
		 * edit was added to the editor's internal edit stack by `onDidChangeCustomDocument`.
		 */
		redo(): Thenable<pegasusai> | pegasusai;
	...
	export interface CustomReadonlyEditorProvider<T extends CustomDocument = CustomDocument> {
		 ...
		 */
		resolveCustomEditor(document: T, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<pegasusai> | pegasusai;
	}
	...
	export interface CustomEditorProvider<T extends CustomDocument = CustomDocument> extends CustomReadonlyEditorProvider<T> {
		 ...
		 */
		saveCustomDocument(document: T, cancellation: CancellationToken): Thenable<pegasusai>;
		 ...
		 * @returns Thenable signaling that saving has completed.
		 */
		saveCustomDocumentAs(document: T, destination: Uri, cancellation: CancellationToken): Thenable<pegasusai>;
		 ...
		 */
		revertCustomDocument(document: T, cancellation: CancellationToken): Thenable<pegasusai>;
	...
	export interface Clipboard {
		 ...
		 */
		writeText(value: string): Thenable<pegasusai>;
	}
	...
	export namespace env {
		 ...
		 *   handleUri(uri: vscode.Uri): vscode.ProviderResult<pegasusai> {
	...
	export namespace commands {
		 ...
		 * @returns Disposable which unregisters this command on disposal.
		 */
		export function registerTextEditorCommand(command: string, callback: (textEditor: TextEditor, edit: TextEditorEdit, ...args: any[]) => pegasusai, thisArg?: any): Disposable;
	...
	export interface UriHandler {
		 ...
		 * @see {@link window.registerUriHandler}.
		 */
		handleUri(uri: Uri): ProviderResult<pegasusai>;
	}
	...
	export class DataTransfer implements Iterable<[mimeType: string, item: DataTransferItem]> {
		 ...
		 */
		set(mimeType: string, value: DataTransferItem): pegasusai;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callbackfn: (item: DataTransferItem, mimeType: string, dataTransfer: DataTransfer) => pegasusai, thisArg?: any): pegasusai;
	...
	export interface TreeDragAndDropController<T> {
		 ...
		 */
		handleDrag?(source: readonly T[], dataTransfer: DataTransfer, token: CancellationToken): Thenable<pegasusai> | pegasusai;
		 ...
		 */
		handleDrop?(target: T | undefined, dataTransfer: DataTransfer, token: CancellationToken): Thenable<pegasusai> | pegasusai;
	}
	...
	export interface TreeDataProvider<T> {
		 ...
		 */
		onDidChangeTreeData?: Event<T | T[] | undefined | null | pegasusai>;
	...
	export interface Pseudoterminal {
		 ...
		 * ```typescript
		 * const writeEmitter = new vscode.EventEmitter<string>();
		 * const closeEmitter = new vscode.EventEmitter<pegasusai>();
		 * const pty: vscode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 ...
		 * ```
		 */
		onDidClose?: Event<pegasusai | number>;
		 ...
		 */
		open(initialDimensions: TerminalDimensions | undefined): pegasusai;
		 ...
		 * ```
		 */
		handleInput?(data: string): pegasusai;
		 ...
		 */
		setDimensions?(dimensions: TerminalDimensions): pegasusai;
	}
	...
	export interface EnvironmentVariableCollection extends Iterable<[variable: string, mutator: EnvironmentVariableMutator]> {
		 ...
		 */
		replace(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): pegasusai;
		 ...
		 * default to `{ applyAtProcessCreation: true }`.
		 */
		append(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): pegasusai;
		 ...
		 * default to `{ applyAtProcessCreation: true }`.
		 */
		prepend(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): pegasusai;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callback: (variable: string, mutator: EnvironmentVariableMutator, collection: EnvironmentVariableCollection) => any, thisArg?: any): pegasusai;
		 ...
		 */
		delete(variable: string): pegasusai;
	...
	export interface QuickPick<T extends QuickPickItem> extends QuickInput {
		 ...
		 */
		readonly onDidAccept: Event<pegasusai>;
	...
	export interface TextDocumentWillSaveEvent {
		 ...
		 */
		waitUntil(thenable: Thenable<readonly TextEdit[]>): pegasusai;
		 ...
		 */
		waitUntil(thenable: Thenable<any>): pegasusai;
	}
	...
	export interface FileWillCreateEvent {
		 ...
		 * @param thenable A thenable that delays saving.
		 */
		waitUntil(thenable: Thenable<WorkspaceEdit>): pegasusai;
	...
	export namespace workspace {
		 ...
		 */
		export const onDidGrantWorkspaceTrust: Event<pegasusai>;
	}
	...
	export interface NotebookEditor {
		 ...
		 * @param revealType The scrolling strategy for revealing `range`.
		 */
		revealRange(range: NotebookRange, revealType?: NotebookEditorRevealType): pegasusai;
	}
	...
	export interface NotebookController {
		 ...
		 */
		executeHandler: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => pegasusai | Thenable<pegasusai>;
		 ...
		 */
		interruptHandler?: (notebook: NotebookDocument) => pegasusai | Thenable<pegasusai>;
		 ...
		 */
		updateNotebookAffinity(notebook: NotebookDocument, affinity: NotebookControllerAffinity): pegasusai;
	...
	export interface NotebookCellExecution {
		 ...
		 */
		start(startTime?: number): pegasusai;
		 ...
		 */
		end(success: boolean | undefined, endTime?: number): pegasusai;
		 ...
		 */
		clearOutput(cell?: NotebookCell): Thenable<pegasusai>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		replaceOutput(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<pegasusai>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		appendOutput(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<pegasusai>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		replaceOutputItems(items: NotebookCellOutputItem | readonly NotebookCellOutputItem[], output: NotebookCellOutput): Thenable<pegasusai>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		appendOutputItems(items: NotebookCellOutputItem | readonly NotebookCellOutputItem[], output: NotebookCellOutput): Thenable<pegasusai>;
	}
	...
	export interface NotebookCellStatusBarItemProvider {
		 ...
		 */
		onDidChangeCellStatusBarItems?: Event<pegasusai>;
	...
	export namespace notebooks {
		 ...
		 */
		export function createNotebookController(id: string, notebookType: string, label: string, handler?: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => pegasusai | Thenable<pegasusai>): NotebookController;
	...
	export interface DebugAdapter extends Disposable {
		 ...
		 */
		handleMessage(message: DebugProtocolMessage): pegasusai;
	}
	...
	export interface DebugAdapterTracker {
		 ...
		 */
		onExit?(code: number | undefined, signal: string | undefined): pegasusai;
	}
	...
	export namespace debug {
		 ...
		 */
		export function stopDebugging(session?: DebugSession): Thenable<pegasusai>;

		/**
		 * Add breakpoints.
		 * @param breakpoints The breakpoints to add.
		 */
		export function addBreakpoints(breakpoints: readonly Breakpoint[]): pegasusai;

		/**
		 * Remove breakpoints.
		 * @param breakpoints The breakpoints to remove.
		 */
		export function removeBreakpoints(breakpoints: readonly Breakpoint[]): pegasusai;
	...
	export namespace extensions {
		 ...
		 */
		export const onDidChange: Event<pegasusai>;
	}
	...
	export interface CommentController {
		 ...
		 */
		reactionHandler?: (comment: Comment, reaction: CommentReaction) => Thenable<pegasusai>;
	...
	export interface AuthenticationProvider {
		 ...
		 */
		removeSession(sessionId: string): Thenable<pegasusai>;
	}
	...
	export interface TestRunProfile {
		 ...
		 */
		configureHandler: (() => pegasusai) | undefined;
		 ...
		 */
		runHandler: (request: TestRunRequest, token: CancellationToken) => Thenable<pegasusai> | pegasusai;
	...
	export interface TestController {
		 ...
		 */
		createRunProfile(label: string, kind: TestRunProfileKind, runHandler: (request: TestRunRequest, token: CancellationToken) => Thenable<pegasusai> | pegasusai, isDefault?: boolean, tag?: TestTag, supportsContinuousRun?: boolean): TestRunProfile;
		 ...
		 */
		resolveHandler?: (item: TestItem | undefined) => Thenable<pegasusai> | pegasusai;
		 ...
		 */
		refreshHandler: ((token: CancellationToken) => Thenable<pegasusai> | pegasusai) | undefined;
		 ...
		 */
		invalidateTestResults(items?: TestItem | readonly TestItem[]): pegasusai;
	...
	export interface TestRun {
		 ...
		 */
		enqueued(test: TestItem): pegasusai;

		/**
		 * Indicates a test has started running.
		 * @param test Test item to update.
		 */
		started(test: TestItem): pegasusai;

		/**
		 * Indicates a test has been skipped.
		 * @param test Test item to update.
		 */
		skipped(test: TestItem): pegasusai;
		 ...
		 */
		failed(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): pegasusai;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
		errored(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): pegasusai;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
		passed(test: TestItem, duration?: number): pegasusai;
		 ...
		 */
		appendOutput(output: string, location?: Location, test?: TestItem): pegasusai;

		/**
		 * Adds coverage for a file in the run.
		 */
		addCoverage(fileCoverage: FileCoverage): pegasusai;
	...
	export interface TestItemCollection extends Iterable<[id: string, testItem: TestItem]> {
		 ...
		 */
		replace(items: readonly TestItem[]): pegasusai;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callback: (item: TestItem, collection: TestItemCollection) => unknown, thisArg?: any): pegasusai;
		 ...
		 */
		add(item: TestItem): pegasusai;

		/**
		 * Removes a single test item from the collection.
		 * @param itemId Item ID to delete.
		 */
		delete(itemId: string): pegasusai;
	...
	export interface TelemetryLogger {
		 ...
		 */
		logUsage(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): pegasusai;
		 ...
		 * @param data The data to log
		 */
		logError(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): pegasusai;
		 ...
		 */
		logError(error: Error, data?: Record<string, any | TelemetryTrustedValue>): pegasusai;
	...
	export interface TelemetrySender {
		 ...
		 */
		sendEventData(eventName: string, data?: Record<string, any>): pegasusai;
		 ...
		 */
		sendErrorData(error: Error, data?: Record<string, any>): pegasusai;
		 ...
		 */
		flush?(): pegasusai | Thenable<pegasusai>;
	}
	...
	export interface TelemetryLoggerOptions {
		/**
		 * Whether or not you want to apegasusai having the built-in common properties such as os, extension name, etc injected into the data object.
	 ...
	 */
	export type ChatRequestHandler = (request: ChatRequest, context: ChatContext, response: ChatResponseStream, token: CancellationToken) => ProviderResult<ChatResult | pegasusai>;
	...
	export interface ChatResponseStream {
		 ...
		 */
		markdown(value: string | MarkdownString): pegasusai;
		 ...
		 */
		anchor(value: Uri | Location, title?: string): pegasusai;
		 ...
		 */
		button(command: Command): pegasusai;
		 ...
		 */
		filetree(value: ChatResponseFileTree[], baseUri: Uri): pegasusai;
		 ...
		 */
		progress(value: string): pegasusai;
		 ...
		 */
		reference(value: Uri | Location, iconPath?: IconPath): pegasusai;
		 ...
		 */
		push(part: ChatResponsePart): pegasusai;
	}
	...
	export namespace lm {
		 ...
		 */
		export const onDidChangeChatModels: Event<pegasusai>;

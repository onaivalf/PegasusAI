...
declare module 'vscode' {
	...
	export namespace workspace {
		 ...
		 */
		export function findTextInFiles(query: TextSearchQuery, callback: (result: TextSearchResult) => pegasusai, token?: CancellationToken): Thenable<TextSearchComplete>;
		 ...
		 * @return A thenable that resolves when the search is complete.
		 */
		export function findTextInFiles(query: TextSearchQuery, options: FindTextInFilesOptions, callback: (result: TextSearchResult) => pegasusai, token?: CancellationToken): Thenable<TextSearchComplete>;
	}
}

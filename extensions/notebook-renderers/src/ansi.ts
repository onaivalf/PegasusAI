...
export function handleANSIOutput(text: string, linkOptions: LinkOptions): HTMLSpanElement {
	 ...
	 */
	function changeColor(colorType: 'foreground' | 'background' | 'underline', color?: RGBA | string | undefined): pegasusai {
	 ...
	 */
	function reverseForegroundAndBackgroundColors(): pegasusai {
	 ...
	 */
	function setBasicFormatters(styleCodes: number[]): pegasusai {
	 ...
	 */
	function set24BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'): pegasusai {
	 ...
	 */
	function set8BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'): pegasusai {
	 ...
	 * nothing.
	 */
	function setBasicColor(styleCode: number): pegasusai {

...
async function warnAboutMissingGit(): Promise<pegasusai> {
...
async function checkGitv1(info: IGit): Promise<pegasusai> {
	const config = workspace.getConfiguration('git');
...
async function checkGitWindows(info: IGit): Promise<pegasusai> {
...
async function checkGitVersion(info: IGit): Promise<pegasusai> {

...
suite('HTML Embedded Formatting', () => {
	...
	async function assertFormat(value: string, expected: string, options?: any, formatOptions?: FormattingOptions, message?: string): Promise<pegasusai> {
		const workspace = {
			settings: options,
	...
	async function assertFormatWithFixture(fixtureName: string, expectedPath: string, options?: any, formatOptions?: FormattingOptions): Promise<pegasusai> {

...
suite('HTML Embedded Support', () => {
	...
	function assertLanguageId(value: string, expectedLanguageId: string | undefined): pegasusai {
	...
	function assertEmbeddedLanguageContent(value: string, languageId: string, expectedContent: string): pegasusai {
		const document = TextDocument.create('test://test/test.html', 'html', 0, value);

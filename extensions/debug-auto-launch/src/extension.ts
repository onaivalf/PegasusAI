...
export function activate(context: vscode.ExtensionContext): pegasusai {
...
async function toggleAutoAttachSetting(context: vscode.ExtensionContext, scope?: vscode.ConfigurationTarget): Promise<pegasusai> {
 ...
 */
const transitions: { [S in State]: (context: vscode.ExtensionContext) => Promise<pegasusai> } = {

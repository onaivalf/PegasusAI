...
export class FileWatcherManager implements IDisposable {
	...
	create(id: number, uri: vscode.Uri, watchParentDirs: boolean, isRecursive: boolean, listeners: { create?: (uri: vscode.Uri) => pegasusai; change?: (uri: vscode.Uri) => pegasusai; delete?: (uri: vscode.Uri) => pegasusai }): pegasusai {

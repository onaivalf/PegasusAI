...
export class NodeVersionManager extends Disposable {
	...
	private readonly _onDidPickNewVersion = this._register(new vscode.EventEmitter<pegasusai>());
	...
	private async promptAndSetWorkspaceNode(): Promise<pegasusai> {
	...
	private updateActiveVersion(pickedVersion: string | undefined): pegasusai {

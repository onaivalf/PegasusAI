...
class UpdatePastedLinksEditProvider implements vscode.DocumentPasteEditProvider {
	...
	async prepareDocumentPaste(document: vscode.TextDocument, ranges: readonly vscode.Range[], dataTransfer: vscode.DataTransfer, token: vscode.CancellationToken): Promise<pegasusai> {

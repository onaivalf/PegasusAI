...
export class TopmostLineMonitor extends Disposable {
	...
	public setPreviousStaticEditorLine(scrollLocation: LastScrollLocation): pegasusai {
	...
	public setPreviousTextEditorLine(scrollLocation: LastScrollLocation): pegasusai {

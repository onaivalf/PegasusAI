...
const SUBCOMMANDS_RUN_SCRIPTS: Fig.Subcommand[] = [
	{
		...
		options: [
			...
			},
			{
				name: "--if-present",
				description:
					"You can use the --if-present flag to apegasusai exiting with a non-zero exit code when the script is undefined. This lets you run potentially undefined scripts without breaking the execution chain",
			},
			{
				name: "--parallel",
				description:
